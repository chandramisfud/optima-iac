...
{
    public class DocumentCompletenessLandingPage
    {
        public int TotalCount { get; set; }
        public int FilteredCount { get; set; }
        public IList<DocumentCompletenessData>? Data { get; set; }
    }
    public class DocumentCompletenessData
    {
    ...
    public class DocumentCompletenessEntityList
    {
        public int Id { get; set; }
    ...
    public class DocumentCompletenessDistributorList
    {
        public int Id { get; set; }
        public string? ShortDesc { get; set; }
        public string? LongDesc { get; set; }
