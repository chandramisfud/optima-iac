namespace Repositories.Entities.Models.DNReceivedAndApproved
{
    public class DNValidateByDistributorHO
    {
    ...
    public class DNMultiApprovalDto
    {
    ...
    public class DNChangeStatusDistributorMultiApproval
    {
        public string? UserId { get; set; }
        public string? status { get; set; }
        public DateTime payment_date { get; set; }
        public IList<DNIdDistMultiApproval>? DNId { get; set; }
    }

    public class DNIdDistMultiApproval
    {
        public int dnid { get; set; }
    }
}