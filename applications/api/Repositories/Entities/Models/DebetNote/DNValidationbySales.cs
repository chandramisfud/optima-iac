...
{
    public class DNValidationbySalesbyId
    {
    ...
    public class DNValidationbySales
    {
        public int Id { get; set; }
        public string? RefId { get; set; }
        public int PromoId { get; set; }
    ...
    public class DNChangeStatusbySales
    {
        public string? UserId { get; set; }
        public string? status { get; set; }
        public IList<DNIdChangeStatusbySales>? dnid { get; set; }
    }

    public class DNIdChangeStatusbySales
    {
        public int dnid { get; set; }
    }
    public class PromobyIdforValidationbySalesRC
    {
    ...
    public class PromobyIdforValidationbySalesDC
    {
        public PromoDisplayData? PromoHeader { get; set; }
        public List<PromoRegionRes>? Regions { get; set; }
        public List<PromoChannelRes>? Channels { get; set; }
    ...
    public class DNValidationbySalesParam
    {
        public int DNId { get; set; }
        public string? status { get; set; }
        public string? notes { get; set; }
    }
    public class DNValidationbySalesEntityList
    {
        public int Id { get; set; }
        public string? ShortDesc { get; set; }
        public string? LongDesc { get; set; }
    }
    public class DNValidationbySalesDistributorList
    {
        public int Id { get; set; }
        public string? ShortDesc { get; set; }
        public string? LongDesc { get; set; }
    ...
    public class RCorDCValue
    {
        public int RCorDC {get; set;}
    }
