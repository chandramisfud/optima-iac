...
{
    public class DNGetbyIdforInvoiceNotification
    {
    ...
    public class DNRejectInvoiceNotificationGlobalResponse
    {
        public int Id { get; set; }
        public string? RefId { get; set; }
    }

    public class DNInvoiceNotificationbyDanoneEntityList
    {
        public int Id { get; set; }
        public string? ShortDesc { get; set; }
        public string? LongDesc { get; set; }
    }
    public class DNInvoiceNotificationbyDanoneDistributorList
    {
        public int Id { get; set; }
        public string? ShortDesc { get; set; }
        public string? LongDesc { get; set; }
    ...
    public class DNInvoiceNotificationbyDanone
    {
        public string? UserId { get; set; }
        public string? status { get; set; }
        public IList<DNIdDNInvoiceNotif>? dnid { get; set; }
    }

    public class DNIdDNInvoiceNotif
    {
        public int dnid { get; set; }
    }
    public class DNChangeStatusInvoiceNotif
    {
        public int Id { get; set; }
        public string? RefId { get; set; }
        public int PromoId { get; set; }
