namespace Repositories.Entities.Models.DNReceivedbyDanone
{
    public class DNReceivedbyDanoneById
    {
    ...
    public class DNReceivedbyDanoneGlobalResponse
    {
        public int Id { get; set; }
        public string? RefId { get; set; }
    }
    public class DNReceivedbyDanone
    {
        public int Id { get; set; }
        public string? RefId { get; set; }
        public int PromoId { get; set; }
    ...
    public class DNReceivedbyDanoneEntityList
    {
        public int Id { get; set; }
        public string? ShortDesc { get; set; }
        public string? LongDesc { get; set; }
    }
    public class DNReceivedbyDanoneDistributorList
    {
        public int Id { get; set; }
        public string? ShortDesc { get; set; }
        public string? LongDesc { get; set; }
    }
    public class DNReceivedbyDanoneApproval
    {
        public int Id { get; set; }
        public string? RefId { get; set; }
        public int PromoId { get; set; }
    ...
    public class DNReceivedbyDanoneApprovalParam
    {
