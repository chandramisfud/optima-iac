...
{
    public class MatrixApprovalListingRepository : IMatrixApprovalListingRepo
    {
        readonly IConfiguration __config;
        public MatrixApprovalListingRepository(IConfiguration config)
        {
            __config = config;
        }
        ...
        public async Task<MatrixApprovalLandingPage> GetMatrixApprovalLandingPage(string period, int categoryId, int entityId, int distributorId,
