...
{
    public partial class AccrualReportRepository 
    {
        public async Task<object> GetChannelSummary(string year, DataTable category, DataTable groupBrand, DataTable channel, DataTable subActivityType,
        ...
        public async Task<object> GetChannelSummaryDownload(string year, DataTable category, DataTable groupBrand, DataTable channel, DataTable subActivityType,
            string profileid, int start, int length,
            string filter, string search)
        {
            try
