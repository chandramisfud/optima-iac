...
{
    public class ListingPromoReportingRepository : IListingPromoReportingRepo
    {
        readonly IConfiguration __config;
        public ListingPromoReportingRepository(IConfiguration config)
        {
            __config = config;
        }
        ...
        public async Task<ListingPromoReportingLandingPage> GetListingPromoReportingLandingPage(string period, int entityId, int distributorId, int budgetParentId, int channelId, string profileId,
        ...
        public async Task<object> GetListingPromoReportingByMechanismLP(string period, int entityId, int distributorId, int budgetParentId, int channelId, string profileId,
           string createFrom, string createTo, string startFrom, string startTo, int submissionParam,
           string keyword, string sortColumn, int categoryId = 0,
           string sortDirection = "ASC", int pageNum = 0, int dataDisplayed = 10)
        {
