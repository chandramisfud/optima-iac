...
$(document).ready(function () {
    ...
    if (localStorage.getItem('docCompletenessState')) {
        dataFilter = JSON.parse(localStorage.getItem('docCompletenessState'));

        url_datatable = '/rpt/doc-completeness/list/paginate/filter?entityId=' + dataFilter.entityId + "&distributorId=" + dataFilter.distributorId;
    } else {
        url_datatable = '/rpt/doc-completeness/list/paginate/filter?entityId=' + $('#filter_entity').val() + "&distributorId=" + $('#filter_distributor').val();
    }
...
$('#dt_document_completeness_view').on('click', function (){
    ...
    let url = "/rpt/doc-completeness/list/paginate/filter?entityId=" + filter_entity + "&distributorId=" + filter_distributor;
    ...
    dt_document_completeness.ajax.url(url).load(function () {
        ...
        localStorage.setItem('docCompletenessState', JSON.stringify(data_filter));
...
$('#btn_export_excel').on('click', function() {
    ...
    let filter_entity = ($('#filter_entity').val()) ?? "";
    let filter_distributor = ($('#filter_distributor').val()) ?? "";
    let url = "/rpt/doc-completeness/export-xls?entityId=" + filter_entity + "&distributorId=" + filter_distributor + "&entity=" + text_entity;
...
const getListEntity = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/rpt/doc-completeness/list/entity",
            type        : "GET",
            dataType    : 'json',
            async       : true,
...
const getListDistributor = (entityId) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/rpt/doc-completeness/list/distributor/entity-id",
            type        : "GET",
            dataType    : 'json',
