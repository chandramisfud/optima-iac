...
$(document).ready(function () {
    ...
    if (localStorage.getItem('promoHistoricalMovementReportState')) {
        dataFilter = JSON.parse(localStorage.getItem('promoHistoricalMovementReportState'));

        url_datatable = '/rpt/promo-historical-movement/list/paginate/filter?period=' + dataFilter.period + "&entityId=" + dataFilter.entityId + "&distributorId=" + dataFilter.distributorId;
    } else {
        url_datatable = '/rpt/promo-historical-movement/list/paginate/filter?period=' + $('#filter_period').val() + "&entityId=" + $('#filter_entity').val() + "&distributorId=" + $('#filter_distributor').val();
    }
...
$('#dt_promo_historical_movement_view').on('click', function (){
    ...
    let url = "/rpt/promo-historical-movement/list/paginate/filter?period=" + filter_period + "&entityId=" + filter_entity + "&distributorId=" + filter_distributor;
    ...
    dt_promo_historical_movement.ajax.url(url).load(function () {
        ...
        localStorage.setItem('promoHistoricalMovementReportState', JSON.stringify(data_filter));
...
$('#btn_export_excel').on('click', function() {
    ...
    let filter_entity = ($('#filter_entity').val()) ?? "";
    let filter_distributor = ($('#filter_distributor').val()) ?? "";
    let url = "/rpt/promo-historical-movement/export-xls?period=" + filter_period + "&entityId=" + filter_entity + "&distributorId=" + filter_distributor + "&entity=" + text_entity;
