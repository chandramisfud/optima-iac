...
$(document).ready(async function () {
    ...
    await loadData(elPeriodStart.val(), elPeriodEnd.val());
});
...
const loadData = async (create_start, create_end) => {
    ...
    getDataSummary(create_start, create_end).then(function () {
...
const getDataLeagues = (createFrom, createTo) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url: "/dashboard/creator/data/leagues-summary",
            type: "GET",
            dataType: 'json',
            data: {
                create_from:createFrom,
...
const getDataCreatorStanding = (createFrom, createTo) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url: "/dashboard/creator/data/leagues-standing",
            type: "GET",
            dataType: 'json',
            data: {
                create_from:createFrom,
