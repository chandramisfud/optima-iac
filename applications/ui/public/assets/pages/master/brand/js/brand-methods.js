...
$(document).ready(function () {
    ...
    dt_brand = $('#dt_brand').DataTable({
        ...
        order: [[1, 'asc']],
        ajax: {
            url: '/master/brand/list/paginate/filter',
            type: 'get',
        },
        processing: true,
        serverSide: true,
                    ...
                    return '\
                        <div class="me-0">\
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-125px w-md-125px shadow p-3 mb-5 bg-body rounded" data-kt-menu="true">\
                                <a class="dropdown-item text-start edit-record" href="/master/brand/form?method=update&brandid=' + data + '"><i class="fa fa-edit fs-6"></i> Edit Data</a>\
...
$('#btn_create').on('click', function() {
    checkFormAccess('create_rec', '', '/master/brand/form', '')
});

$("#dt_brand").on('click', '.delete-record', function () {
    let tr = this.closest("tr");
    let trdata = dt_brand.row(tr).data();
    checkFormAccess('delete_rec', trdata.brandId, '', "Are your sure to delete data " + trdata.brandRefId)
});

const fDeleteRecord = (brandid) => {
    let formData = new FormData();
    formData.append('id', brandid);
    $.ajax({
        url: '/master/brand/delete',
        data: formData,
        type: 'POST',
        async: true,
        dataType: 'JSON',
...
$('#btn_export_excel').on('click', function() {
    ...
    a.href = "/master/brand/export-xls";
