...
$(document).ready(function () {
    ...
    dt_region = $('#dt_region').DataTable({
        ...
        order: [[1, 'asc']],
        ajax: {
            url: '/master/region/list/paginate/filter',
            type: 'get',
        },
        processing: true,
        serverSide: true,
                    ...
                    return '\
                        <div class="me-0">\
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-125px w-md-125px shadow p-3 mb-5 bg-body rounded" data-kt-menu="true">\
                                <a class="dropdown-item text-start edit-record" href="/master/region/form?method=update&regionid=' + data + '"><i class="fa fa-edit fs-6"></i> Edit Data</a>\
...
$('#btn_create').on('click', function() {
    checkFormAccess('create_rec', '', '/master/region/form', '')
});

$("#dt_region").on('click', '.delete-record', function () {
    let tr = this.closest("tr");
    let trdata = dt_region.row(tr).data();
...
$('#btn_export_excel').on('click', function() {
    ...
    a.href = "/master/region/export-xls";
