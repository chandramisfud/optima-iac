...
$('#dt_promo_list_view').on('click',  function () {
    ...
    let url = "/dn/upload/get-data/promo?period=" +  filter_period + "&subAccountId=0" + "&entityId=" + filter_entity + "&channelId=" + filter_channel;
