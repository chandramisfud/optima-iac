...
$('.btn_view').on('click', function() {
    ...
    let fileName = $('#review_file_label_' + docLink).text();

    let path = '/dn/promo-display/view-file?promoId=' + promoId + "&docLink=row" + docLink + "&fileName=" + encodeURIComponent(fileName);
