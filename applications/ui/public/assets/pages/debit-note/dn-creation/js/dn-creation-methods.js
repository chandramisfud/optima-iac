                    ...
                    if (full.isCancel) {
                        ...
                        if (full.isFreeze) {
                            return '<div class="me-0">' +
                                ...
                                '<a class="dropdown-item text-start print-record" href="/dn/creation/print-pdf?&id=' + data + '" target="_blank"><i class="fa fa-print fs-6 me-2"></i> Print DN</a>' +
                                '<a class="dropdown-item text-start upload-attach" href="/dn/creation/dn-upload-attach?method=upload&id=' + data + '"><i class="fa fa-cloud-upload-alt fs-6 me-2"></i> Upload DN Attach </a>' +
                                '<a class="dropdown-item text-start view-record" href="/dn/creation/dn-display?method=view&id=' + data + '"><i class="la la-opencart fs-6 me-2"></i> DN Display </a>' +
                                '</div>' +
                                '</div>';
                        } else {
                            return '<div class="me-0">' +
                                ...
                                '</a>' +
                                '<div class="menu menu-sub menu-sub-dropdown w-180px w-md-180px shadow p-3 mb-5 bg-body rounded" data-kt-menu="true">' +
                                '<a class="dropdown-item text-start edit-record" href="/dn/creation/form?method=update&id=' + data + '"><i class="fa fa-file-alt fs-6 me-2"></i> Edit DN </a>' +
...
$('#btn_create').on('click', function (){
    checkFormAccess('create_rec', '', '/dn/creation/form', '')
});
...
$('#dt_dn_creation_view').on('click', function (){
    ...
    let url = "/dn/creation/list/paginate/filter?period=" + filter_period + "&subAccountId=" + filter_subaccount;
