...
$('#dt_promo_list_view').on('click',  function () {
    ...
    let url;
    if (method === 'update') {
        url = "/dn/creation/get-data/promo?period=" +  filter_period + "&subAccountId=" + $('#subAccountId').val() + "&entityId=" + $('#entityId').val() + "&channelId=" + filter_channel;
    } else {
        url = "/dn/creation/get-data/promo?period=" +  filter_period + "&subAccountId=0" + "&entityId=" + filter_entity + "&channelId=" + filter_channel;
    }
