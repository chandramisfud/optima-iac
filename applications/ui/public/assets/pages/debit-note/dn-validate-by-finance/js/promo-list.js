...
$('#dt_promo_list').on( 'dblclick', 'tr', function () {
    ...
    $('#entityId').val(data.entityName).trigger('change');
...
$('#dt_promo_list_view').on('click',  function () {
    ...
    let url = "/dn/creation-ho/get-data/promo?period=" +  filter_period + "&subAccountId=" + $('#subAccountId').val() + "&entityId=" + $('#entityId').val() + "&channelId=" + filter_channel;
