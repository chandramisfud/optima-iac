...
var swalTitle = "Debet Note [Validate By HO]";
...
$(document).ready(function () {
    ...
    const v_notes = function () {
        return {
            validate: function () {
                if ($('#approvalStatusCode').val() === 'rejected_by_dist_ho') {
    ...
    validator = FormValidation.formValidation(document.getElementById('form_approval'), {
        fields: {
            approvalStatusCode: {
                validators: {
                    notEmpty: {
...
$('#btn_approve').on('click', function () {
    validator.validate().then(function (status) {
        if (status == "Valid") {
            ...
            let url = '/dn/validate-by-ho/save';
            $.ajax({
                url         : url,
                data        : formData,
                type        : 'POST',
                ...
                success: function(result, status, xhr, $form) {
                    if (!result.error) {
                        Swal.fire({
                            ...
                            window.location.href = '/dn/validate-by-ho';
                        });
                    } else {
                        Swal.fire({
                            text: result.message,
