...
var swalTitle = "Debit Note [Reassignment] By Finance";
heightContainer = 280;
...
$(document).ready(function () {
    ...
    dt_dn_reassignment = $('#dt_dn_reassignment').DataTable({
        ...
        ajax: {
            url: '/dn/reassignment-by-finance/list',
            type: 'GET',
        },
        processing: true,
        serverSide: true,
                    ...
                    return '\
                        <div class="me-0">\
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-200px w-md-200px shadow p-3 mb-5 bg-body rounded" data-kt-menu="true">\
                                <a class="dropdown-item text-start reassignment-record" href="/dn/reassignment-by-finance/form?method=update&id=' + data + '"><i class="fa fa-edit fs-6"></i> Reassign Promo By Finance</a>\
                            </div>\
                        </div>\
                    ';
                }
