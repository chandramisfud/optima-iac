...
var swalTitle = "Debit Note [Resssignment] by Finance";
var id, arrTaxLevel = [], year, entityId, accountId, promoId, internalOrderNumber, refId;
...
$('#btn_search_promo').on('click',  function () {
    ...
    let url = "/dn/reassignment-by-finance/get-data/promo?period=" +  year + "&accountId=" + accountId + "&entityId=" + entityId + "&channelId=0";
...
$('#btn_save').on('click', function () {
    ...
    $.get('/refresh-csrf').done(function(data) {
        ...
        let url = '/dn/reassignment-by-finance/save';
            ...
            success: function(result, status, xhr, $form) {
                if (!result.error) {
                    Swal.fire({
                        ...
                        window.location.href = '/dn/reassignment-by-finance';
                    });
                } else {
                    Swal.fire({
                        title: swalTitle,
...
$('#download_all').on('click', function () {
    let url = "/dn/reassignment-by-finance/download-zip?id=" + id;
...
const getData = (id) => {
    return new Promise(function (resolve, reject) {
        $.ajax({
            url: "/dn/reassignment-by-finance/get-data/id",
            type: "GET",
            data: {id: id},
            dataType: 'json',
            async: true,
