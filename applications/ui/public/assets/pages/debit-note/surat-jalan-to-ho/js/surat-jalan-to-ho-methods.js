...
$(document).ready(function () {
    ...
    dt_surat_jalan = $('#dt_surat_jalan').DataTable({
        ...
        order: [[2, 'asc']],
        ajax: {
            url: '/dn/surat-jalan-ho/list?senddate=' + $('#filter_date').val(),
            type: 'get',
        },
        processing: true,
        serverSide: false,
                    ...
                    return '\
                        <div class="me-0">\
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-150px w-md-150px shadow p-3 mb-5 bg-body rounded" data-kt-menu="true">\
                                <a class="dropdown-item text-start print-record" href="/dn/surat-jalan-ho/print-pdf?&id=' + data + '" target="_blank"><i class="fa fa-print fs-6"></i> Print Surat Jalan</a>\
                            </div>\
                        </div>\
                    ';
                }
...
$('#dt_surat_jalan_view').on('click', function (){
    ...
    let url = "/dn/surat-jalan-ho/list?senddate=" + filter_date;
