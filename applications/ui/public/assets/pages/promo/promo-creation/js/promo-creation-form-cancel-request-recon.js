...
let dt_mechanism, dt_mechanism_list, dt_mechanism_list_creation, dt_sku;
...
const getData = (pId) => {
    return new Promise((resolve) => {
        $.ajax({
            url: "/promo/creation/display-recon/id",
            type: "GET",
            data: {id: pId},
            dataType: "JSON",
            success: async function (result) {
                if (!result['error']) {
                    ...
                    if (promo['mechanismInputMethod']) {
                        ...
                        $('#tblMechanismFreeTextCreation').addClass('d-none');
                        ...
                        $('#tblMechanismFreeTextCreation').removeClass('d-none');
