...
let swalTitle = "DN Information";
let id, arrTaxLevel = [], refId;
...
$('#download_all').on('click', function () {
    let url = "/rpt/dn-display/download-zip?id=" + id;
...
const getData = (id) => {
    return new Promise(function (resolve, reject) {
        $.ajax({
            url: "/rpt/dn-display/get-data/id",
            type: "GET",
            data: {id: id},
            dataType: 'json',
            async: true,
            success: function (result) {
                if (!result.error) {
                    ...
                    $('#entityAddress').text(value['entityAddress']);
...
const getListTaxLevel = () => {
    return new Promise(function (resolve, reject) {
        $.ajax({
            url         : "/promo/approval-recon/list/tax-level",
            type        : "GET",
            dataType    : 'json',
            async       : true,
            success: function(result) {
