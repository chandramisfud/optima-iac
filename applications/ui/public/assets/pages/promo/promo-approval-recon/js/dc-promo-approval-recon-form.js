...
var swalTitle = "Promo Approval Reconcile";
var dt_mechanism, id, validator, groupBrandId, categoryId, subCategoryId, listChannel = [], listSubChannel = [], listSubActivityType = [];
        ...
        $.ajax({
            ...
            success: async function (result) {
                if (!result.error) {
                    ...
                    // Previous
                    $('#preInvestment').val(formatMoney(header.lastInvestment, 0) ?? "0");
