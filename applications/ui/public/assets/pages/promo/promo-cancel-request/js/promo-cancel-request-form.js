...
var validator, method, promoId, createOn, createBy, channelId, subChannelId, accountId, subAccountId, newMechanismMethod, dt_mechanism;
...
var swalTitle = "Promo Cancel Request";
        ...
        $.ajax({
            ...
            success: function (result) {
                if (!result.error) {
                    ...
                    createBy = values.promoHeader.createBy;
