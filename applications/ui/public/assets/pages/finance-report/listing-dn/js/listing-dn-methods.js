...
$(document).ready(function () {
    ...
    if (localStorage.getItem('financeListingDNReportState')) {
        dataFilter = JSON.parse(localStorage.getItem('financeListingDNReportState'));

        url_datatable = '/fin-rpt/listing-dn/list/paginate/filter?period=' + dataFilter.period + "&entityId=" + dataFilter.entityId + "&distributorId=" + dataFilter.distributorId;
    } else {
        url_datatable = '/fin-rpt/listing-dn/list/paginate/filter?period=' + $('#filter_period').val() + "&entityId=" + $('#filter_entity').val() + "&distributorId=" + $('#filter_distributor').val();
    }
...
$('#dt_listing_dn_view').on('click', function (){
    ...
    let url = "/fin-rpt/listing-dn/list/paginate/filter?period=" + filter_period + "&entityId=" + filter_entity + "&distributorId=" + filter_distributor;
    ...
    dt_listing_dn.ajax.url(url).load(function () {
        ...
        localStorage.setItem('financeListingDNReportState', JSON.stringify(data_filter));
...
$('#btn_export_excel').on('click', function() {
    ...
    let filter_entity = ($('#filter_entity').val()) ?? "";
    let filter_distributor = ($('#filter_distributor').val()) ?? "";
    let url = "/fin-rpt/listing-dn/export-xls?period=" + filter_period + "&entityId=" + filter_entity + "&distributorId=" + filter_distributor + "&entity=" + text_entity;
...
const getListEntity = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/listing-dn/list/entity",
            type        : "GET",
            dataType    : 'json',
            async       : true,
...
const getListDistributor = (entityId) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/listing-dn/list/distributor/entity-id",
            type        : "GET",
            dataType    : 'json',
