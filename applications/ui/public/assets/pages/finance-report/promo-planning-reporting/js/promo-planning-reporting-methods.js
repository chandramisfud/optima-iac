...
$(document).ready(function () {
    ...
    if (localStorage.getItem('financePromoPlanningReportingState')) {
        dataFilter = JSON.parse(localStorage.getItem('financePromoPlanningReportingState'));

        url_datatable = '/fin-rpt/promo-planning-reporting/list/paginate/filter?period=' + dataFilter.period +
        ...
        url_datatable = '/fin-rpt/promo-planning-reporting/list/paginate/filter?period=' + $('#filter_period').val() +
...
$('#dt_promo_planning_reporting_view').on('click', function (){
    ...
    let url = "/fin-rpt/promo-planning-reporting/list/paginate/filter?period=" + filter_period + "&startFrom=" + filter_activity_start + "&startTo=" + filter_activity_end
    ...
    dt_promo_planning_reporting.ajax.url(url).load(function () {
        ...
        localStorage.setItem('financePromoPlanningReportingState', JSON.stringify(data_filter));
...
$('#btn_export_excel').on('click', function() {
    ...
    let filter_distributor = ($('#filter_distributor').val()) ?? "";
    let filter_channel = ($('#filter_channel').val()) ?? "";
    let url = "/fin-rpt/promo-planning-reporting/export-xls?period=" + filter_period + "&startFrom=" + filter_activity_start + "&startTo=" + filter_activity_end
...
const getListEntity = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/promo-planning-reporting/list/entity",
            type        : "GET",
            dataType    : 'json',
            async       : true,
...
const getListDistributor = (entityId) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/promo-planning-reporting/list/distributor/entity-id",
            type        : "GET",
            dataType    : 'json',
...
const getListChannel = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/promo-planning-reporting/list/channel",
            type        : "GET",
            dataType    : 'json',
            async       : true,
            success: function(result) {
