...
$(document).ready(function () {
    ...
    if (localStorage.getItem('financeSkpValidationState')) {
        dataFilter = JSON.parse(localStorage.getItem('financeSkpValidationState'));

        url_datatable = '/fin-rpt/skp-validation/list/paginate/filter?period=' + dataFilter.period +
        ...
        url_datatable = '/fin-rpt/skp-validation/list/paginate/filter?period=' + $('#filter_period').val() +
...
$('#dt_skp_validation_view').on('click', function (){
    ...
    let url = "/fin-rpt/skp-validation/list/paginate/filter?period=" + filter_period + "&startFrom=" + filter_activity_start + "&startTo=" + filter_activity_end
    ...
    dt_skp_validation.ajax.url(url).load(function () {
        ...
        localStorage.setItem('financeSkpValidationState', JSON.stringify(data_filter));
...
$('#btn_export_excel').on('click', function() {
    ...
    let filter_distributor = ($('#filter_distributor').val()) ?? "";
    let filter_channel = ($('#filter_channel').val()) ?? "";
    let url = "/fin-rpt/skp-validation/export-xls?period=" + filter_period + "&startFrom=" + filter_activity_start + "&startTo=" + filter_activity_end
...
const getListEntity = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/skp-validation/list/entity",
            type        : "GET",
            dataType    : 'json',
            async       : true,
...
const getListDistributor = (entityId) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/skp-validation/list/distributor/entity-id",
            type        : "GET",
            dataType    : 'json',
...
const getListChannel = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/skp-validation/list/channel",
            type        : "GET",
            dataType    : 'json',
            async       : true,
            success: function(result) {
