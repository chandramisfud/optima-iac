...
$(document).ready(function () {
    ...
    if (localStorage.getItem('financeSummaryAgingApprovalReportState')) {
        dataFilter = JSON.parse(localStorage.getItem('financeSummaryAgingApprovalReportState'));

        url_datatable = '/fin-rpt/summary-aging-approval/list/paginate/filter?period=' + dataFilter.period + "&entityId=" + dataFilter.entityId + "&distributorId=" + dataFilter.distributorId;
    } else {
        url_datatable = '/fin-rpt/summary-aging-approval/list/paginate/filter?period=' + $('#filter_period').val() + "&entityId=" + $('#filter_entity').val() + "&distributorId=" + $('#filter_distributor').val();
    }
...
$('#dt_summary_aging_approval_view').on('click', function (){
    ...
    let url = "/fin-rpt/summary-aging-approval/list/paginate/filter?period=" + filter_period + "&entityId=" + filter_entity + "&distributorId=" + filter_distributor;
    ...
    dt_summary_aging_approval.ajax.url(url).load(function () {
        ...
        localStorage.setItem('financeSummaryAgingApprovalReportState', JSON.stringify(data_filter));
...
$('#btn_export_excel').on('click', function() {
    ...
    let filter_entity = ($('#filter_entity').val()) ?? "";
    let filter_distributor = ($('#filter_distributor').val()) ?? "";
    let url = "/fin-rpt/summary-aging-approval/export-xls?period=" + filter_period + "&entityId=" + filter_entity + "&distributorId=" + filter_distributor + "&entity=" + text_entity;
...
const getListEntity = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/summary-aging-approval/list/entity",
            type        : "GET",
            dataType    : 'json',
            async       : true,
...
const getListDistributor = (entityId) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/summary-aging-approval/list/distributor/entity-id",
            type        : "GET",
            dataType    : 'json',
