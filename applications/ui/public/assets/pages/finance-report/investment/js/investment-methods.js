...
$(document).ready(function () {
    ...
    if (localStorage.getItem('FinanceInvestmentReportState')) {
        dataFilter = JSON.parse(localStorage.getItem('FinanceInvestmentReportState'));

        url_datatable = '/fin-rpt/investment/list/paginate/filter?period=' + dataFilter.period +
            "&budgetAllocationId=" + dataFilter.budgetAllocationId + "&entityId=" + dataFilter.entityId + "&distributorId=" + dataFilter.distributorId;
    } else {
        url_datatable = '/fin-rpt/investment/list/paginate/filter?period=' + $('#filter_period').val() + "&budgetAllocationId=" + $('#filter_budget_allocation_id').val()  +
...
$('#btn_search_budget_allocation').on('click', function () {
    ...
    dt_budget_allocation_list.ajax.url("/fin-rpt/investment/list/budget-allocation?year=" + year + '&entityId=' + entityId +
...
$('#dt_investment_report_view').on('click', function (){
    ...
    let url = "/fin-rpt/investment/list/paginate/filter?period=" + filter_period + "&budgetAllocationId=" + filter_budget_allocation_id
    ...
    dt_investment_report.ajax.url(url).load(function () {
        ...
        localStorage.setItem('FinanceInvestmentReportState', JSON.stringify(data_filter));
...
$('#btn_export_excel').on('click', function() {
    ...
    let filter_entity = ($('#filter_entity').val()) ?? "";
    let filter_distributor = ($('#filter_distributor').val()) ?? "";
    let url = "/fin-rpt/investment/export-xls?period=" + filter_period + "&budgetAllocationId=" + filter_budget_allocation_id
...
const getListEntity = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/investment/list/entity",
            type        : "GET",
            dataType    : 'json',
            async       : true,
...
const getListDistributor = (entityId) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/investment/list/distributor/entity-id",
            type        : "GET",
            dataType    : 'json',
