...
$(document).ready(function () {
    ...
    if (localStorage.getItem('financeListingPromoReportingByMechanismState')) {
        dataFilter = JSON.parse(localStorage.getItem('financeListingPromoReportingByMechanismState'));

        url_datatable = '/fin-rpt/listing-promo-reporting-by-mechanism/list/paginate/filter?period=' + dataFilter.period +
        ...
        url_datatable = '/fin-rpt/listing-promo-reporting-by-mechanism/list/paginate/filter?period=' + elFilterPeriod.val() + "&startFrom=" + $('#filter_activity_start').val()  + "&startTo=" + $('#filter_activity_end').val();
    }
...
$('#dt_listing_promo_reporting_by_mechanism_search').on('keyup', function () {
...
elFilterPeriod.on('change', function() {
...
elFilterPeriod.on('blur', async function () {
...
$('#dt_listing_promo_reporting_by_mechanism_view').on('click', function (){
    ...
    let url = "/fin-rpt/listing-promo-reporting-by-mechanism/list/paginate/filter?period=" + filter_period + "&startFrom=" + filter_activity_start + "&startTo=" + filter_activity_end
    ...
    dt_listing_promo_reporting_by_mechanism.ajax.url(url).load(function () {
        ...
        localStorage.setItem('financeListingPromoReportingByMechanismState', JSON.stringify(data_filter));
    }).on('xhr.dt', function () {
        btn.setAttribute("data-kt-indicator", "off");
        btn.disabled = !1;
    });
...
$('#btn_export_excel').on('click', function() {
    ...
    let filter_channel = ($('#filter_channel').val()) ?? "";
    let url = "/fin-rpt/listing-promo-reporting-by-mechanism/export-xls?period=" + filter_period + "&startFrom=" + filter_activity_start + "&startTo=" + filter_activity_end + "&categoryId=" + filter_category
...
$('#btn_export_csv').on('click', function() {
    ...
    let filter_distributor = ($('#filter_distributor').val()) ?? "";
    let filter_channel = ($('#filter_channel').val()) ?? "";
    let url = "/fin-rpt/listing-promo-reporting-by-mechanism/export-csv?period=" + filter_period + "&startFrom=" + filter_activity_start + "&startTo=" + filter_activity_end + "&categoryId=" + filter_category
        + "&entityId=" + filter_entity + "&distributorId=" + filter_distributor + "&channelId=" + filter_channel + "&category=" + text_category + "&entity=" + text_entity + "&distributor=" + text_distributor;
...
const getListCategory = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/listing-promo-reporting-by-mechanism/list/category",
            type        : "GET",
            dataType    : 'json',
            async       : true,
...
const getListEntity = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/listing-promo-reporting-by-mechanism/list/entity",
            type        : "GET",
            dataType    : 'json',
            async       : true,
            success: function(result) {
...
const getListDistributor = (entityId) => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/listing-promo-reporting-by-mechanism/list/distributor",
            type        : "GET",
            dataType    : 'json',
...
const getListChannel = () => {
    return new Promise((resolve, reject) => {
        $.ajax({
            url         : "/fin-rpt/listing-promo-reporting-by-mechanism/list/channel",
            type        : "GET",
            dataType    : 'json',
            async       : true,
            success: function(result) {
