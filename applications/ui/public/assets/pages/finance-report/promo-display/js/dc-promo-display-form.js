...
$('.btn_view').on('click', function () {
    ...
    let preview_path = '/fin-rpt/promo-display/view-file?promoId=' + promoId + "&docLink=row" + row + "&fileName=" + encodeURIComponent(fileName);
...
$('#btn_export_pdf').on('click', function() {
    window.open( "/fin-rpt/promo-display/export-pdf?id=" + promoId , "_blank");
});
