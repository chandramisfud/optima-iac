...
var validator;
var swalTitle = "Upload Data Master Sub Activity Type";
...
$(document).ready(function () {
    ...
    validator = FormValidation.formValidation(document.querySelector("#form_sub_activity_type"), {
        fields: {
            file: {
...
$('#btn_upload').on('click', function() {
    validator.validate().then(function (status) {
        if (status === "Valid") {
            ...
            var formData = new FormData($('#form_sub_activity_type')[0]);
            let url = '/tools/upload-sub-activity-type/upload-xls';
            $.ajax({
                url: url,
                data: formData,
                type: 'POST',
