...
var validator;
var swalTitle = "Upload Data Master Region";
...
$(document).ready(function () {
    ...
    validator = FormValidation.formValidation(document.querySelector("#form_region"), {
        fields: {
            file: {
...
$('#btn_upload').on('click', function() {
    validator.validate().then(function (status) {
        if (status === "Valid") {
            ...
            var formData = new FormData($('#form_region')[0]);
            let url = '/tools/upload-region/upload-xls';
            $.ajax({
                url: url,
                data: formData,
                type: 'POST',
