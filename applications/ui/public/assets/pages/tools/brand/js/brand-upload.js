...
var validator;
var swalTitle = "Upload Data Master Brand";
...
$(document).ready(function () {
    ...
    validator = FormValidation.formValidation(document.querySelector("#form_brand"), {
        fields: {
            file: {
...
$('#btn_upload').on('click', function() {
    validator.validate().then(function (status) {
        if (status === "Valid") {
            ...
            var formData = new FormData($('#form_brand')[0]);
            let url = '/tools/upload-brand/upload-xls';
            $.ajax({
                url: url,
                data: formData,
                type: 'POST',
