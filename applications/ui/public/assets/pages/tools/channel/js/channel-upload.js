...
var validator;
var swalTitle = "Upload Data Master Channel";
...
$(document).ready(function () {
    ...
    validator = FormValidation.formValidation(document.querySelector("#form_channel"), {
        fields: {
            file: {
...
$('#btn_upload').on('click', function() {
    validator.validate().then(function (status) {
        if (status === "Valid") {
            ...
            var formData = new FormData($('#form_channel')[0]);
            let url = '/tools/upload-channel/upload-xls';
            $.ajax({
                url: url,
                data: formData,
                type: 'POST',
