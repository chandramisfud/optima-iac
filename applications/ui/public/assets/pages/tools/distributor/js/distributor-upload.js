...
var validator;
var swalTitle = "Upload Data Master Distributor";
...
$(document).ready(function () {
    ...
    validator = FormValidation.formValidation(document.querySelector("#form_distributor"), {
        fields: {
            file: {
...
$('#btn_upload').on('click', function() {
    validator.validate().then(function (status) {
        if (status === "Valid") {
            ...
            var formData = new FormData($('#form_distributor')[0]);
            let url = '/tools/upload-distributor/upload-xls';
            $.ajax({
                url: url,
                data: formData,
                type: 'POST',
