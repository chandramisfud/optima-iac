...
var validator;
var swalTitle = "Upload Data Master Activity";
...
$(document).ready(function () {
    ...
    validator = FormValidation.formValidation(document.querySelector("#form_activity"), {
        fields: {
            file: {
...
$('#btn_upload').on('click', function() {
    validator.validate().then(function (status) {
        if (status === "Valid") {
            ...
            var formData = new FormData($('#form_activity')[0]);
            let url = '/tools/upload-activity/upload-xls';
            $.ajax({
                url: url,
                data: formData,
                type: 'POST',
