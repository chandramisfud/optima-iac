...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->planNormalSales,0,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->planIncrSales,0,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->planTotSales,0,".",",") }}</td>
    </tr>
    <tr>
