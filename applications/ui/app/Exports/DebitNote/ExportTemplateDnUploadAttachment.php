<?php
namespace App\Exports\DebitNote;
...
class ExportTemplateDnUploadAttachment implements FromArray, WithHeadings, ShouldAutoSize, WithEvents,  WithStrictNullComparison
{
    protected $data;
    protected $heading;
