...
class ExportBudgetTTConsole implements FromArray, WithHeadings, ShouldAutoSize, WithEvents, WithColumnFormatting,  WithStrictNullComparison
{
    protected $data;
    protected $heading;
    ...
    public function __construct($data, $heading = [], $headingcell1 = '', $headingcell2 = '', $formatcell = [], $cellNoInput = '')
    {
        $this->data = $data;
