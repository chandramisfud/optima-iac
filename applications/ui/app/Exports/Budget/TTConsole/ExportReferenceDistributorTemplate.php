...
class ExportReferenceDistributorTemplate implements FromArray, WithHeadings, ShouldAutoSize, WithColumnFormatting, WithTitle, WithEvents
{
    protected $data;
    protected $heading;
