...
class ExportBudgetSSInputPSInput implements FromArray, WithHeadings, ShouldAutoSize, WithEvents, WithColumnFormatting,  WithStrictNullComparison
{
    protected $data;
    protected $heading;
    ...
    public function __construct($data, $heading = [], $headingcell1 = '', $formatcell = [], $cellNoInput = '')
    {
        $this->data = $data;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getStyle($this->cellNoInput)->applyFromArray([
                    'fill' => [
                        'fillType' => Fill::FILL_SOLID,
                        'color' => [
                            'rgb' => 'CBD1D7'
                ...
                $event->sheet->getStyle('D1:P1')->applyFromArray([
                    'alignment' => [
                        'horizontal' => \PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_RIGHT,
                    ],
                ]);
