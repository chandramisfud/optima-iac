    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2-5 col-md-8 col-sm-8 col-8 mb-lg-0 mb-2">
                            <div class="inner-addon left-addon right-addon">
                                ...
                                <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_mechanism_Search" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-lg-5 offset-4-5 col-md-4 col-sm-4 col-4 mb-lg-0 mb-2 text-end">
                            <a href="javascript:void(0)" class="btn btn-sm btn-icon me-2" id="download_template" title="Download Template Excel">
                                <i class="fa fa-download" style="font-size: 1.8rem; color: black"></i>
                            </a>
                            <a href="javascript:void(0)" class="btn btn-sm btn-icon me-2" id="uploadxls" title="Upload Excel">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/master/promo-mechanism/js/promo-mechanism-methods.js?v=5') }}"></script>
@endsection
