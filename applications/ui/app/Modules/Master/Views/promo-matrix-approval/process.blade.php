...
<head>
    ...
    <link href="{{ asset('assets/pages/master/promo-matrix-approval/css/promo-matrix-approval-process.css') }}" rel="stylesheet" type="text/css" />
</head>
<!--end::Head-->
<!--begin::Body-->
<body class="bg-body">
...
<script src="{{ asset('assets/pages/master/promo-matrix-approval/js/promo-matrix-approval-process.js') }}"></script>
</body>
</html>
