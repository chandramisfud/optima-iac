...
@section('page-style')
    <link href="{{ asset('assets/pages/master/promo-matrix-approval/css/promo-matrix-approval-methods.css') }}"  rel="stylesheet" type="text/css" />
@endsection
...
@section('button-toolbar-left')
    ...
    <button type="button" class="btn btn-sm btn-outline-optima text-hover-white" id="btn_upload_form">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="inner-addon left-addon right-addon">
                                ...
                                <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_matrix_approval_search" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="text-end">
                                <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="dt_matrix_approval_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_matrix_approval" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
                </div>
            </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/master/promo-matrix-approval/js/promo-matrix-approval-methods.js?v=4') }}"></script>
@endsection
