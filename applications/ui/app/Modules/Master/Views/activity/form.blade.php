...
@section('title', 'Form Activity Promo')
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <form id="form_activity" class="form" autocomplete="off">
                        @csrf
...
@section('page-script')
    <script src="{{ asset('assets/pages/master/activity/js/activity-form.js?v=2') }}"></script>
@endsection
