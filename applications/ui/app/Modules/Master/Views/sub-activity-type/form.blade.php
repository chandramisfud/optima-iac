...
@section('title', 'Form Activity Type Promo')
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <form id="form_subactivitytype" class="form" autocomplete="off">
                        @csrf
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control form-control-sm" type="text" name="shortDesc" id="shortDesc" autocomplete="off" tabindex="1" />
                            </div>
                        </div>
                        <div class="row fv-row">
...
@section('page-script')
    <script src="{{ asset('assets/pages/master/sub-activity-type/js/sub-activity-type-form.js?v=1') }}"></script>
@endsection
