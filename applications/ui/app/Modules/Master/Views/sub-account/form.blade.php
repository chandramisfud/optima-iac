...
@section('title', 'Form Sub Account')
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <form id="form_subaccount" class="form" autocomplete="off">
                        @csrf
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-select form-select-sm select-subchannel" data-control="select2" name="subchannel" id="subchannel" data-placeholder="Select a Sub Channel"  data-allow-clear="true" tabindex="2">
                                    <option></option>
                                </select>
                            </div>
                        </div>
                        <div class="row fv-row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-select form-select-sm select-account" data-control="select2" name="account" id="account" data-placeholder="Select a Account"  data-allow-clear="true" tabindex="3">
                                    <option></option>
                                </select>
                            </div>
                        </div>
...
@section('page-script')
    <script src="{{ asset('assets/pages/master/sub-account/js/sub-account-form.js?v=2') }}"></script>
@endsection
