...
@section('title', 'Form Sub Category Promo')
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <form id="form_subcategory" class="form" autocomplete="off">
                        @csrf
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-select form-select-sm select-account" data-control="select2" name="category" id="category" data-placeholder="Select a Category"  data-allow-clear="true" tabindex="1">
                                    <option></option>
                                </select>
                            </div>
                        </div>
...
@section('page-script')
    <script src="{{ asset('assets/pages/master/sub-category/js/sub-category-form.js?v=1') }}"></script>
@endsection
