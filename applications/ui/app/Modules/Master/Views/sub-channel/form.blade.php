...
@section('title', 'Form Sub Channel')
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <form id="form_subchannel" class="form" autocomplete="off">
                        @csrf
...
@section('page-script')
    <script src="{{ asset('assets/pages/master/sub-channel/js/sub-channel-form.js?v=1') }}"></script>
@endsection
