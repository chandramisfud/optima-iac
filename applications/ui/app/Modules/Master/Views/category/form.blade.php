...
@section('title', 'Form Category Promo')
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <form id="form_category" class="form" autocomplete="off">
                        @csrf
...
@section('page-script')
    <script src="{{ asset('assets/pages/master/category/js/category-form.js?v=1') }}"></script>
@endsection
