...
use App\Exports\Master\ExportViewMasterSubActivityType;
...
class SubActivityType extends Controller
{
    ...
    {
        return view('Master::sub-activity-type.index');
    }

    public function getListPaginateFilter(Request $request)
    {
        $api = config('app.api'). '/master/subactivitytype';
        try {
            $page = 0;
            if ($request->length > -1) {
    ...
    public function subActivityTypeFormPage(Request $request) {
        return view('Master::sub-activity-type.form');
    }

    public function getDataByID(Request $request) {
        $api = config('app.api'). '/master/subactivitytype/id';
        try {
