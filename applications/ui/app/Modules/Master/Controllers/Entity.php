...
use App\Exports\Master\ExportViewMasterEntity;
...
class Entity extends Controller
{
    ...
    {
        return view('Master::entity.index');
    }

    public function getListPaginateFilter(Request $request) {
        $api = config('app.api'). '/master/entity';
        try {
            $page = 0;
            if ($request->length > -1) {
    ...
    public function entityFormPage(Request $request) {
        return view('Master::entity.form');
    }

    public function getDataByID(Request $request) {
        $api = config('app.api'). '/master/entity/id';
        try {
