...
@section('page-style')
    <link href="{{ asset('assets/pages/tools/matrix-approval/css/matrix-approval-upload.css') }}" rel="stylesheet"
          type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/tools/matrix-approval/js/matrix-approval-upload.js?v=2') }}"></script>
@endsection
