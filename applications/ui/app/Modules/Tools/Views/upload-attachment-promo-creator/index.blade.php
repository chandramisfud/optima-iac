...
@section('page-style')
    <link href="{{ asset('assets/pages/tools/upload-attachment-promo-creator-methods/css/upload-attachment-promo-creator-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <form class="form_promo_attachment_creator" method="post" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Input group-->
                                <div class="fv-row">
                                    <!--begin::Dropzone-->
                                    <div class="dropzone" id="dropzone_promo_creator" name="dropzone_promo_creator">
                                        <!--begin::Message-->
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/tools/upload-attachment-promo-creator/js/upload-attachment-promo-creator-methods.js?v=4') }}"></script>
@endsection
