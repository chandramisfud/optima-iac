...
@section('title', 'Master Sub Activity Type')
    ...
    <div class="row mb-7">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <form id="form_sub_activity_type" class="form" autocomplete="off">
                        @csrf
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/tools/js/sub-activity-type/sub-activity-type-upload.js') }}"></script>
@endsection
