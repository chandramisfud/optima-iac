...
@section('page-style')
    <link href="{{ asset('assets/pages/finance-report/listing-promo-reporting-by-mechanism/css/listing-promo-reporting-by-mechanism-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-12 col-sm-12 mb-lg-1 mb-2">
                                    ...
                                    <span class="svg-icon svg-icon-3 svg-icon-gray-500 position-absolute translate-middle ms-6" style="padding-top: 32px">
                                        ...
                                        <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_listing_promo_reporting_by_mechanism_search" autocomplete="off">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-1-5 col-md-12 col-sm-12 mb-lg-1 mb-2">
                            <div class="text-end">
                                <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="dt_listing_promo_reporting_by_mechanism_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_listing_promo_reporting_by_mechanism" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/listing-promo-reporting-by-mechanism/js/listing-promo-reporting-by-mechanism-methods.js') }}"></script>
@endsection
