...
@section('page-style')
    <link href="{{ asset('assets/pages/finance-report/document-completeness/css/document-completeness-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="inner-addon left-addon right-addon">
                                ...
                                <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_document_completeness_search" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1-5 offset-lg-20-percent col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="text-end">
                                <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="dt_document_completeness_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_document_completeness" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/document-completeness/js/document-completeness-methods.js?v=2') }}"></script>
@endsection
