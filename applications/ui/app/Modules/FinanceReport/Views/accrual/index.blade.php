...
@section('button-toolbar-right')
    @include('toolbars.btn-download-list-back')
@endsection
...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="inner-addon left-addon right-addon">
                                ...
                                <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_fin_accrual_search" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2-5 col-md-12 col-sm-12 px-lg-1 mb-lg-0 mb-2">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control form-control-sm" name="filter_closing_date" id="filter_closing_date" value="{{ @date('Y-m-d') }}">
                            </div>
                        </div>

                        <div class="col-lg-2-75 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="text-end">
                                <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="dt_fin_accrual_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_fin_accrual" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('FinanceReport::accrual.report-header-list')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/accrual/js/accrual-methods.js?v=8') }}"></script>
    <script src="{{ asset('assets/pages/finance-report/accrual/js/accrual-report-header-list.js?v=2') }}"></script>
@endsection
