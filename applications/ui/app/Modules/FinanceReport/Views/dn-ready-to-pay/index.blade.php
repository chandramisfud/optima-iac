                ...
                <div class="card-body">
                    <div class="row">
                        <div class="d-flex justify-content-between flex-lg-row flex-column">
                            <div class="row w-lg-100">
                                <div class="col-lg-2 col-12">
                                    <div class="inner-addon left-addon right-addon">
                                        ...
                                        <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_dn_ready_to_pay_search" autocomplete="off">
                                    </div>
                                </div>
                            ...
                            <div class="ms-5">
                                <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto text-nowrap w-100 mb-2" id="dt_dn_ready_to_pay_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_dn_ready_to_pay" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/dn-ready-to-pay/js/dn-ready-to-pay-methods.js?v=3') }}"></script>
@endsection
