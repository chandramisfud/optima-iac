...
@section('page-style')
    <link href="{{ asset('assets/pages/finance-report/dn-display/css/dn-display-form.css') }}" rel="stylesheet" type="text/css"/>
@endsection
            ...
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="row">
                                <label class="col-lg-4 offset-lg-2 col-form-label">DN Creator </label>
                                <div class="col-lg-6">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" name="dnCreator" id="dnCreator" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/dn-display/js/dn-display-form.js?v=3') }}"></script>
@endsection
