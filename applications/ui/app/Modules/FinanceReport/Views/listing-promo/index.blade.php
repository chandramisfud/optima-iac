                    ...
                    <div class="row">
                        <div class="col-lg-11 col-12">
                            <div class="row">
                                ...
                                <label class="position-relative w-lg-60px text-lg-end px-lg-0 pt-lg-2">Period</label>
                                ...
                                <div class="position-relative w-lg-200px w-fhd-250px ms-lg-3 mb-2">
                        ...
                        <div class="col-lg-1 col-12">
                            <div class="position-relative w-lg-75px w-fhd-100px ps-lg-0 float-lg-end ms-lg-3 mb-2">
                                <button type="button" class="btn btn-sm btn-outline-optima w-100" id="dt_listing_dn_view">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/listing-dn/js/listing-dn-methods.js?v=1') }}"></script>
@endsection
