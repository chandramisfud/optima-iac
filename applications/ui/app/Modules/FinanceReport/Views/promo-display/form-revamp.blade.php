...
@section('page-style')
    <link href="{{ asset('assets/pages/finance-report/promo-display/css/promo-display-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row fv-row">
                                        <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="totalClaim">DN Claim</label>
                                        <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                            <input type="text" class="form-control form-control-sm form-control-solid-bg text-end" name="totalClaim" id="totalClaim" autocomplete="off" readonly/>
                                        </div>
                                    </div>
                                    <div class="row fv-row">
                                        <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="totalPaid">DN Paid</label>
                                        <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                            <input type="text" class="form-control form-control-sm form-control-solid-bg text-end" name="totalPaid" id="totalPaid" autocomplete="off" readonly/>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row mb-2 d-none" id="mechanismFreeText">
        <div class="col-12">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/promo-display/js/promo-display-form-revamp.js?v=6') }}"></script>
@endsection
