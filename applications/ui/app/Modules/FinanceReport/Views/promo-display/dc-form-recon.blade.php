...
@section('page-style')
    <link href="{{ asset('assets/pages/finance-report/promo-display/css/dc-promo-display-form-recon.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/promo-display/js/promo-display-dc-form-recon.js?v=4') }}"></script>
@endsection
