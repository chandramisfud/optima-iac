...
@section('page-style')
    <link href="{{ asset('assets/pages/finance-report/promo-display/css/dc-promo-display-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/promo-display/js/promo-display-dc-form-revamp.js?v=5') }}"></script>
@endsection
