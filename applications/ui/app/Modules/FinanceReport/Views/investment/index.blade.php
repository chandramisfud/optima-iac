...
@section('page-style')
    <link href="{{ asset('assets/pages/finance-report/investment/css/investment-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="inner-addon left-addon right-addon">
                                ...
                                <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_investment_report_search" autocomplete="off">
                            </div>
                        </div>

                        <div class="col-fhd-10-percent col-lg-2-5 col-md-12 col-sm-12 px-lg-1 mb-lg-0 mb-2">
                            <div class="row">
                        ...
                        <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2 pe-lg-1">
                            <div class="row px-lg-1">
                                <label class="col-lg-5 text-lg-end px-lg-1 pt-1232-2">Allocation ID</label>
                                <div class="col-lg-7 px-lg-1">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control form-control-sm" id="filter_budget_allocation_id" placeholder="Allocation ID" aria-label="Allocation ID" aria-describedby="basic-addon2" autocomplete="off">
                                        <span class="input-group-text cursor-pointer btn-outline-optima" id="btn_search_budget_allocation">
                        ...
                        <div class="col-fhd-1-15 col-lg-1-5 col-md-12 col-sm-12 px-lg-1 mb-lg-0 mb-2">
                            <div class="text-end">
                                <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="dt_investment_report_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <table id="dt_investment_report" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
    ...
    @include('Report::investment.budget-allocation-list')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/finance-report/investment/js/investment-methods.js?v=4') }}"></script>
    <script src="{{ asset('assets/pages/finance-report/investment/js/budget-allocation-list.js') }}"></script>
@endsection
