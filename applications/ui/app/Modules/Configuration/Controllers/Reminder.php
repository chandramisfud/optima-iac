...
class Reminder extends Controller
{
    ...
    {
        $title = "Approval Reminder Configuration";
        return view('Configuration::reminder.index', compact('title'));
    }

    public function getDataConfig(Request $request)
    {
        $api = config('app.api'). '/config/reminder/type';
        $query = [
            'reminderType'           => 100,
        ];
    ...
    {
        $api = config('app.api') . '/config/reminder';
        $data = [
