...
class PromoInitiatioReminder extends Controller
{
    ...
    {
        $title = "Promo Initiator Reminder Configuration";
        return view('Configuration::promo-initiator-reminder.index', compact('title'));
    }

    public function getDataConfig(Request $request)
    {
        $api = config('app.api'). '/config/promoinitiatorreminder';
