                    ...
                    <div class="row">
                        <div class="col-12">
                            <form id="form_upload" class="form" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="text-end">
                                        <button type="button" class="btn btn-sm btn-optima" id="btn_download">
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header px-5">
                    <span class="card-title fs-3">Promo Calculator Configuration Upload <small class="text-muted fs-6 my-0 fw-bold ms-5">List</small></span>
                </div>
                <div class="card-body">
                    <div class="row">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/configuration/promo-calculator/js/promo-calculator-form-upload.js') }}"></script>
@endsection
