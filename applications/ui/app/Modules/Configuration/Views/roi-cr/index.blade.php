...
@section('page-style')
    <link href="{{ asset('assets/pages/configuration/roi-cr/css/roi-cr-methods.css') }}"  rel="stylesheet" type="text/css" />
@endsection
...
@section('button-toolbar-left')
    @include('toolbars.btn-configuration')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/configuration/roi-cr/js/roi-cr-methods.js?v=4') }}"></script>
@endsection
