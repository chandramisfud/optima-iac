...
@section('page-style')
    <link href="{{ asset('assets/pages/configuration/major-changes/css/major-changes-methods.css?v=' . microtime()) }}"  rel="stylesheet" type="text/css" />
@endsection
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6 col-12">
                                                <div class="row mb-3">
                                                    <div class="d-flex flex-lg-row flex-column w-100 align-items-lg-center">
                                                        <div class="w-lg-33 w-auto">
                                                            <label for="budgetSources" class="">Budget Source</label>
                                                        </div>
                                                        <div class="w-lg-50 w-auto">
                                                            <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                                                <input class="form-check-input" type="checkbox" role="switch" id="budgetSources" name="budgetSources" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="d-flex flex-lg-row flex-column w-100 align-items-lg-center">
                                                        <div class="w-lg-33 w-auto">
                                                            <label for="activityDesc" class="">Activity Description</label>
                                                        </div>
                                                        <div class="w-lg-50 w-auto">
                                                            <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                                                <input class="form-check-input" type="checkbox" role="switch" id="activityDesc" name="activityDesc" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-12">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="d-flex flex-lg-row flex-column w-100 align-items-lg-center">
                                                        ...
                                                        <div class="w-lg-50 w-auto">
                                                            <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                                                <input class="form-check-input" type="checkbox" role="switch" id="brand" name="brand" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6 col-12">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="d-flex flex-lg-row flex-column w-100 align-items-lg-center">
                                                        <div class="w-lg-33 w-auto">
                                                            <label for="subCategoryDC" class="">Sub Activity Type</label>
                                                        </div>
                                                        <div class="w-lg-50 w-auto">
                                                            <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                                                <input class="form-check-input" type="checkbox" role="switch" id="subCategoryDC" name="subCategory" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="d-flex flex-lg-row flex-column w-100 align-items-lg-center">
                                                        <div class="w-lg-33 w-auto">
                                                            <label for="budgetSourcesDC" class="">Budget Source</label>
                                                        </div>
                                                        <div class="w-lg-50 w-auto">
                                                            <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                                                <input class="form-check-input" type="checkbox" role="switch" id="budgetSourcesDC" name="budgetSources" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/configuration/major-changes/js/major-changes-methods.js?v=5') }}"></script>
@endsection
