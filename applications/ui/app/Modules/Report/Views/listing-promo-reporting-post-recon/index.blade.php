...
@section('page-style')
    <link href="{{ asset('assets/pages/report/listing-promo-reporting-post-recon/css/listing-promo-reporting-post-recon-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/listing-promo-reporting-post-recon/js/listing-promo-reporting-post-recon-methods.js') }}"></script>
@endsection
