...
@section('page-style')
    <link href="{{ asset('assets/pages/report/document-completeness/css/document-completeness-methods.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/document-completeness/js/document-completeness-methods.js?v=6') }}"></script>
@endsection
