...
@section('page-style')
    <link href="{{ asset('assets/pages/report/listing-promo-reporting/css/listing-promo-reporting-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/listing-promo-reporting/js/listing-promo-reporting-methods.js?v=5') }}"></script>
@endsection
