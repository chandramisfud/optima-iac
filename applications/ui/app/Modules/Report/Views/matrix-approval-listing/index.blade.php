...
@section('page-style')
    <link href="{{ asset('assets/pages/report/matrix-approval-listing/css/matrix-approval-listing-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/matrix-approval-listing/js/matrix-approval-listing-methods.js?v=10') }}"></script>
@endsection
