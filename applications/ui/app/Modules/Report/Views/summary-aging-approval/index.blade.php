...
@section('page-style')
    <link href="{{ asset('assets/pages/report/summary-aging-approval/css/summary-aging-approval-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/summary-aging-approval/js/summary-aging-approval-methods.js?v=5') }}"></script>
@endsection
