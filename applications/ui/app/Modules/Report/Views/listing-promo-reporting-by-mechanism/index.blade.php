...
@section('page-style')
    <link href="{{ asset('assets/pages/report/listing-promo-reporting-by-mechanism/css/listing-promo-reporting-by-mechanism-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/listing-promo-reporting-by-mechanism/js/listing-promo-reporting-by-mechanism-methods.js?v=5') }}"></script>
@endsection
