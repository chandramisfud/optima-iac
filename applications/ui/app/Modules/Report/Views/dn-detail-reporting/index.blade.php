...
@section('page-style')
    <link href="{{ asset('assets/pages/report/dn-detail-reporting/css/dn-detail-reporting-methods.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/dn-detail-reporting/js/dn-detail-reporting-methods.js?v=12') }}"></script>
@endsection
