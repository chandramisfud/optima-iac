...
@section('page-style')
    <link href="{{ asset('assets/pages/report/investment/css/investment-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/investment/js/investment-methods.js?v=6') }}"></script>
    <script src="{{ asset('assets/pages/report/investment/js/budget-allocation-list.js?v=1') }}"></script>
@endsection
