...
@section('page-style')
    <link href="{{ asset('assets/pages/report/skp-validation/css/skp-validation-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/skp-validation/js/skp-validation-methods.js?v=6') }}"></script>
@endsection
