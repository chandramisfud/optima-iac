...
@section('page-style')
    <link href="{{ asset('assets/pages/report/listing-dn/css/listing-dn-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/listing-dn/js/listing-dn-methods.js?v=5') }}"></script>
@endsection
