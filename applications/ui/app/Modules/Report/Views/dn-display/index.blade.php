...
@section('page-style')
    <link href="{{ asset('assets/pages/report/dn-display/css/dn-display-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/dn-display/js/dn-display-methods.js?v=6') }}"></script>
@endsection
