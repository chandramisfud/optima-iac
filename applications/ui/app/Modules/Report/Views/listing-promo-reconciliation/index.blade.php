...
@section('page-style')
    <link href="{{ asset('assets/pages/report/listing-promo-reconciliation/css/listing-promo-reconciliation-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/report/listing-promo-reconciliation/js/listing-promo-reconciliation-methods.js?v=2') }}"></script>
@endsection
