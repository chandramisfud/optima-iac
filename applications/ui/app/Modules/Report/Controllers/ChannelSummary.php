...
class ChannelSummary extends Controller
{
    ...
    public function landingPage(): Factory|View|Application
    {
        ...
        return view('Report::channel-summary.index', compact('title'));
    }

    public function getListPaginateFilter(Request $request): array|bool|string
    {
        try {
            $api = '/report/channelsummary';
    ...
    {
        $api = '/report/channelsummary/filter';
        $callApi = new CallApi();
