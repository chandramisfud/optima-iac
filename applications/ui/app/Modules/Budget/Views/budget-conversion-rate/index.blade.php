...
@section('page-style')
    <link href="{{ asset('assets/pages/budget/budget-conversion-rate/css/budget-conversion-rate-methods.css?v=' . microtime()) }}" rel="stylesheet" type="text/css"/>
@endsection
                ...
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2">
                                    <div class="inner-addon left-addon right-addon">
                                        ...
                                        <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_budget_conversion_rate_search" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2">
                                    <select class="form-select form-select-sm" data-control="select2" name="filter_sub_channel" id="filter_sub_channel" data-placeholder="Select a Sub Channel"  data-allow-clear="true" multiple="multiple" autocomplete="off">
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-sm-12 mb-lg-0 mb-2">
                                    <div class="text-end">
                                        <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100 me-2 mb-2" id="dt_budget_conversion_rate_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_budget_conversion_rate" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
                </div>
            </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/budget/budget-conversion-rate/js/budget-conversion-rate-methods.js?v=10') }}"></script>
@endsection
