                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-lg-10-5 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="col-lg-3 col-md-12 col-sm-12 mb-lg-1 mb-2">
                                    ...
                                    <span class="svg-icon svg-icon-3 svg-icon-gray-500 position-absolute translate-middle ms-6" style="padding-top: 32px">
                                        ...
                                        <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_budget_volume_search" autocomplete="off">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-12 col-sm-12 mb-lg-0 mb-2">
                                    <select class="form-select form-select-sm" data-control="select2" name="filter_region" id="filter_region" data-placeholder="Select a Region"  data-allow-clear="true" multiple="multiple" autocomplete="off">
                                    </select>
                                </div>
                                <div class="col-lg-3 col-md-12 col-sm-12 mb-lg-0 mb-2">
                        ...
                        <div class="col-lg-1-5 col-md-12 col-sm-12 mb-lg-1 mb-2">
                            <div class="text-end">
                                <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="dt_budget_volume_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_budget_volume" class="table table-striped table-row-bordered table-responsive table-sm table-hover">
                                <thead>
                                <tr>
                                    <th rowspan="2" style="background-color: #5867dd;">Period</th>
                                    ...
                                    <th rowspan="2" style="background-color: #5867dd;">Region</th>
                                    <th rowspan="2" style="background-color: #5867dd;">Brand</th>
                                    <th colspan="7" style="text-align: center"></th>
                                    <th colspan="6" style="text-align: center;">SS In Tons</th>
                                    <th colspan="12" style="text-align: center; border-left: white solid thin">Conversion Rate</th>
                                    <th colspan="13" style="text-align: center; border-left: white solid thin">SS In Value</th>
                                </tr>
                                <tr>
                                    <th>Jan</th>
                                    <th>Feb</th>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/budget/budget-volume/js/budget-volume-methods.js?v=10') }}"></script>
@endsection
