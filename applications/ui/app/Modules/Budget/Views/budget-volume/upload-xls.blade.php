...
@section('page-style')
    <link href="{{ asset('assets/pages/budget/budget-volume/css/budget-volume-upload-xls.css') }}" rel="stylesheet" type="text/css" />
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header px-5">
                    <span class="card-title fs-3">Budget Volume Upload <small class="text-muted fs-6 my-0 fw-bold ms-5">List</small></span>
                </div>
                <div class="card-body">
                    <div class="row">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/budget/budget-volume/js/budget-volume-upload-xls.js?v=5') }}"></script>
@endsection
