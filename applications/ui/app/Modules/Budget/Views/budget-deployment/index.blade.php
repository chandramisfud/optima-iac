                ...
                <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between flex-lg-row flex-column">
                            <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2">
                                <div class="inner-addon left-addon right-addon">
                                    ...
                                    <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_budget_deployment_detail_search" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="flex-grow-1 mx-lg-1 mb-2">
                                <select class="form-select form-select-sm" data-control="select2" name="filter_sub_activity_type" id="filter_sub_activity_type" data-placeholder="Select a Sub Activity Type" multiple="multiple" data-allow-clear="true">
                                </select>
                            </div>

                            <div class="flex-grow-1">
                                <div class="text-end">
                                    <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100 me-2 mb-2" id="btn_view">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100 me-2 mb-2" id="btn_deploy">
                                        Budget Deploy
                                        <span class="indicator-progress">
                                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                                        </span>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12">
                            <table id="dt_budget_deployment_detail" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
                </div>
            </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/budget/budget-deployment/js/budget-deployment-methods.js?v=7') }}"></script>
@endsection
