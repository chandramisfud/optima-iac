...
<!--begin::Head-->
<head>
    <title>Optima System - Budget Deployment Process</title>
    <meta charset="utf-8" />
    ...
    <link href="{{ asset('assets/pages/budget/budget-deployment/css/budget-deployment-process.css?v=1') }}" rel="stylesheet" type="text/css" />
</head>
<!--end::Head-->
<!--begin::Body-->
<body class="bg-body">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                ...
                <div class="card shadow card_form">
                    <div class="card-body">
                        <div class="row mb-5">
                            <div class="col-lg-12 col-12">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <span class="fs-2qx text-gray-800">Processing Budget Deployment</span>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-12 col-12 text-center" id="info_sending_progress">
...
<script src="{{ asset('assets/pages/budget/budget-deployment/js/budget-deployment-process.js') }}"></script>
</body>
</html>
