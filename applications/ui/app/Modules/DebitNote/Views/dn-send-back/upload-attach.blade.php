...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/dn-send-back/css/dn-send-back-form.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-send-back/js/dn-send-back-upload-attach.js?v=' .microtime()) }}"></script>
@endsection
