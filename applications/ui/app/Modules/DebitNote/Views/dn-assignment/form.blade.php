...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/dn-assignment/css/dn-assignment-form.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('content')
        ...
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="text-end">
                            <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="btn-forward">
                                <span class="indicator-label">
                                    <span class="la la-mail-forward">
                                        <span id="forwardApprover"></span>
                                    </span>
                                </span>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="row fv-row">
                                <label class="col-lg-4 col-form-label required">Sub Account</label>
                                <div class="col-lg-8">
                            ...
                            <div class="row fv-row">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <span class="input-group-text cursor-pointer btn-outline-optima" id="btn_search_promo" tabindex="1">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="row fv-row d-none" id="internal-order-number">
                                <label class="col-lg-4 offset-lg-2 col-form-label required">Internal Order Number </label>
                                <div class="col-lg-6">
                                    <input class="form-control form-control-sm" type="text" name="internalOrderNumber" id="internalOrderNumber" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="row">
    ...
    @include('DebitNote::dn-assignment.promo-list')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-assignment/js/dn-assignment-form.js?v=' . microtime()) }}"></script>
    <script src="{{ asset('assets/pages/debit-note/dn-assignment/js/promo-list.js?v=' . microtime()) }}"></script>
@endsection
