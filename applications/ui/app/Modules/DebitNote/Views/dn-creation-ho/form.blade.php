...
@section('content')
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <div class="d-flex align-items-center rounded py-3 px-3 mb-5 d-none" id="text-warning" style="background-color: darkblue">
                            ...
                            <div class="badge badge-square" role="alert">
                                <div class="alert-text">
                                    <h3 class="text-white align-center">
                                        Untick Trade Promo for DN Non Trade Promo
                                    </h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group input-group-sm">
                                            <div class="col-3">
                                                <input type="numeric" class="form-control form-control-sm text-end" value="10" inputmode="decimal" onClick="this.select();" name="ppnPct" id="ppnPct" value="0" autocomplete="off"/>
                                            </div>
                                            <span class="input-group-text px-5">%</span>
    ...
    @include('DebitNote::dn-creation-ho.promo-list')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-creation-ho/js/dn-creation-ho-form.js?v=34') }}"></script>
    <script src="{{ asset('assets/pages/debit-note/dn-creation-ho/js/promo-list.js?v=8') }}"></script>
@endsection
