...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/dn-creation-ho/css/dn-creation-ho-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection

@section('breadcrumb')
    <span class="d-flex align-items-center fs-3 my-1">@yield('title')
        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
        <small class="text-muted fs-6 fw-bold my-1 ms-1" id="txt_info_method">List</small>
    </span>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="inner-addon left-addon right-addon">
                                ...
                                <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_dn_creation_search" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2-5 col-md-12 col-sm-12 mb-lg-0">
                            <select class="form-select form-select-sm" data-control="select2" name="filter_subaccount" id="filter_subaccount" data-placeholder="Select a SubAccount"  data-allow-clear="true">
                                <option></option>
                            </select>
                        </div>

                        <div class="col-lg-2-5 col-md-12 col-sm-12 px-lg-1 mb-lg-0"></div>

                        <div class="col-lg-2-75 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="text-end">
                                <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="dt_dn_creation_view">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_dn_creation" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
                </div>
            </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-creation-ho/js/dn-creation-ho-methods.js?v=3') }}"></script>
@endsection
