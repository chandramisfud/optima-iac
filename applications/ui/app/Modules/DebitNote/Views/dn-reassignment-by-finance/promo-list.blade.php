            ...
            <div class="modal-body">
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 mb-lg-0 mb-2">
                        <select class="form-select form-select-sm form-control-solid-bg" data-control="select2" name="filter_entity" id="filter_entity" data-placeholder="Select an Entity"  data-allow-clear="true" disabled>
                            <option></option>
                        </select>
                    </div>

                    <div class="col-lg-3 col-md-12 col-sm-12 mb-lg-0 mb-2">
                        <select class="form-select form-select-sm" data-control="select2" name="filter_distributor" id="filter_channel" data-dropdown-parent="#modal_list_promo" data-placeholder="Select a Channel"  data-allow-clear="true">
                            <option></option>
                        </select>
                    </div>
