...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/dn-reassignment-by-finance/css/dn-reassignment-by-finance-form.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('content')
    ...
    @include('DebitNote::dn-reassignment-by-finance.promo-list')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-reassignment-by-finance/js/dn-reassignment-by-finance-form.js?v=' . microtime()) }}"></script>
    <script src="{{ asset('assets/pages/debit-note/dn-reassignment-by-finance/js/promo-list.js?v=' . microtime()) }}"></script>
@endsection
