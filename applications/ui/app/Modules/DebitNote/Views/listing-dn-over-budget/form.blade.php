...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/listing-dn-over-budget/css/listing-dn-over-budget-form.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('content')
    ...
    @include('DebitNote::listing-dn-over-budget.promo-list')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/listing-dn-over-budget/js/listing-dn-over-budget-form.js?v=' . microtime()) }}"></script>
    <script src="{{ asset('assets/pages/debit-note/listing-dn-over-budget/js/promo-list.js?v=' . microtime()) }}"></script>
@endsection
