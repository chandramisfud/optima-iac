...
@section('breadcrumb')
    <span class="d-flex align-items-center fs-3 my-1">@yield('title')
        ...
        <small class="text-muted fs-6 fw-bold mt-1 ms-1" id="txt_info_method">Upload Faktur</small>
    </span>
@endsection
...
@section('content')
        ...
        <div class="col-12">
            <div class="card card-flush shadow card_form">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <form id="form_upload_faktur" class="form" autocomplete="off">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="d-flex flex-lg-row flex-column justify-content-between">
                                        <button type="button" class="btn btn-sm btn-optima" id="btn_download_template">
    ...
    <div class="row d-none" id="list_uploaded">
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header px-5">
                    <span class="card-title fs-3">Debit Note Upload <small class="text-muted fs-6 my-0 fw-bold ms-5">List</small></span>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/upload-faktur/js/upload-faktur-methods.js?v=' . microtime()) }}"></script>
@endsection
