...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/dn-creation/css/dn-creation-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-creation/js/dn-creation-methods.js?v=2') }}"></script>
@endsection
