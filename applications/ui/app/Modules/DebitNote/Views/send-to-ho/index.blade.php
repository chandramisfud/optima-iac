                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-11 col-12">
                            <div class="row">
                                <div class="position-relative w-lg-150px w-fhd-250px mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_send_to_ho_search" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_send_to_ho" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
                </div>
            </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/send-to-ho/js/send-to-ho-methods.js?v=3') }}"></script>
@endsection
