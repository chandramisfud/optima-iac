                ...
                <div class="card-body">
                    <div class="row mb-5">
                        <div class="col-lg-2-5 col-md-8 col-sm-8 col-8 mb-lg-0 mb-2">
                            <div class="inner-addon left-addon right-addon">
                                ...
                                <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_validate_by_ho_search" autocomplete="off">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_validate_by_ho" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
                </div>
            </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/validate-by-ho/js/validate-by-ho-methods.js?v=3') }}"></script>
@endsection
