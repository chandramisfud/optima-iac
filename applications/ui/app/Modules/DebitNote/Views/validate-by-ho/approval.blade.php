                            ...
                            <div class="row fv-row">
                                <div class="col-lg-6">
                                    <select class="form-select form-select-sm" data-control="select2" name="approvalStatusCode" id="approvalStatusCode" data-placeholder="Select validation status" autocomplete="off" data-allow-clear="true">
                                        <option></option>
                                        <option value="validate_by_dist_ho">Validated</option>
                                        <option value="rejected_by_dist_ho">Rejected</option>
                                    </select>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="btn_approve">
                                    <span class="indicator-label">
                                    <span class="la la-check"></span> Submit
                                    </span>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/validate-by-ho/js/validate-by-ho-approval.js?v=' .microtime()) }}"></script>
@endsection
