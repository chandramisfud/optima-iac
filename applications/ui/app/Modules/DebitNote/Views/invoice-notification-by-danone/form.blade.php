    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <div class="row">
                        <form id="form_reject" class="form" autocomplete="off">
                            @csrf
                            <div class="row mb-2">
                                <div class="col-lg-6">
                            ...
                            <div class="row fv-row mb-2">
                                <div class="col-lg-6 mb-2">
                                    <textarea type="text" class="form-control form-control-sm" id="notes" name="notes" rows="3" autofocus autocomplete="off"></textarea>
                                </div>
                                <div class="col-lg-6">
                                    <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100" id="btn_reject">
                                    <span class="indicator-label">
                                    <span class="la la-mail-reply"></span> Reject
                                    </span>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/invoice-notification-by-danone/js/invoice-notification-by-danone-form.js?v=' .microtime()) }}"></script>
@endsection
