...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/dn-reassignment/css/dn-reassignment-form.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-reassignment/js/dn-reassignment-form.js?v=' . microtime()) }}"></script>
    <script src="{{ asset('assets/pages/debit-note/dn-reassignment/js/promo-list.js?v=' . microtime()) }}"></script>
@endsection
