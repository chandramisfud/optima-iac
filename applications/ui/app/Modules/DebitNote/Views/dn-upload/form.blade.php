...
@section('content')
    ...
    @include('DebitNote::dn-upload.promo-list')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-upload/js/dn-upload-form.js?v=1') }}"></script>
    <script src="{{ asset('assets/pages/debit-note/dn-upload/js/promo-list.js?v=1') }}"></script>
@endsection
