...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/dn-upload/css/dn-upload-form.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-upload/js/dn-upload-attach.js?v=' .microtime()) }}"></script>
@endsection
