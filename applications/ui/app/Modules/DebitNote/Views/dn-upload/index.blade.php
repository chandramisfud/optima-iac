...
@section('page-style')
    <link href="{{ asset('assets/pages/debit-note/dn-upload/css/dn-upload-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/debit-note/dn-upload/js/dn-upload-methods.js?v=2') }}"></script>
@endsection
