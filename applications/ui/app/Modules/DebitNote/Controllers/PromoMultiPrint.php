...
class PromoMultiPrint extends Controller
{
    ...
    public function landingPage()
    {
        ...
        return view('DebitNote::promo-multi-print.index', compact('title'));
    }

    public function getList(Request $request)
    {
        $api = config('app.api'). '/dn/multiprint-promo';
    ...
    public function printPdf(Request $request) {
        ...
        if ($dataPromo[0]->yearPromo >= 2025) {
            ...
            $viewPrint = 'DebitNote::promo-multi-print.printout-revamp-pdf';
        } else {
            $api = config('app.api') . '/promo/display/id';
            $viewPrint = 'DebitNote::promo-multi-print.printout-pdf';
        }
