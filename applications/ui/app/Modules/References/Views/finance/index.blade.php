...
@section('page-style')
    <link href="{{ asset('assets/pages/references/finance/css/finance-methods.css') }}" rel="stylesheet" type="text/css"/>
@endsection

@section('breadcrumb')
    <span class="d-flex align-items-center fs-3 my-1">@yield('title')
        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
        <small class="text-muted fs-6 fw-bold mt-1 ms-1" id="txt_info_method">Finance</small>
    </span>
@endsection
...
@section('page-script')
    <script src="{{ asset('assets/pages/references/finance/js/finance-methods.js') }}"></script>
@endsection
