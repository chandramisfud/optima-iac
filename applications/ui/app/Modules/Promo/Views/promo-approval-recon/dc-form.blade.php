                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="row fv-row">
                                <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="entity">Brand</label>
                                <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                            ...
                            <div class="row fv-row">
                                <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="preInvestment">Previous Investment</label>
                                <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                    <input type="text" class="form-control form-control-sm text-end" data-kt-dialer-control="input" name="preInvestment" id="preInvestment" autocomplete="off" value="0" inputmode="decimal" onClick="this.select();" tabindex="11" readonly/>
                                </div>
                            </div>

                            <div class="row fv-row">
                                <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="investment">Current Investment</label>
                                <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-approval-recon/js/dc-promo-approval-recon-form.js?v=8') }}"></script>
    <script src="{{ asset('assets/pages/promo/promo-approval-recon/js/dn-list.js') }}"></script>
@endsection
