...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-approval/css/dc-promo-approval-form-recon.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-approval-recon/js/dc-promo-approval-form-revamp.js') }}"></script>
@endsection
