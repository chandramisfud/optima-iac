...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-approval-recon/css/dn-display.css') }}" rel="stylesheet" type="text/css"/>
@endsection
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="year" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-4 col-form-label" for="accountDesc">Sub Account </label>
                                <div class="col-lg-8">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="accountDesc" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-4 col-form-label" for="sellingPoint">Selling Point </label>
                                <div class="col-lg-8">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="sellingPoint" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-4 col-form-label" for="promoRefId">Promo ID </label>
                                <div class="col-lg-8">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="promoRefId" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-4 col-form-label" for="entityLongDesc">Entity </label>
                                <div class="col-lg-8">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="entityLongDesc" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="entityUp" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="row">
                                <label class="col-lg-4 offset-lg-2 col-form-label" for="dnCreator">DN Creator </label>
                                <div class="col-lg-6">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="dnCreator" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-4 offset-lg-2 col-form-label" for="taxLevel">Tax Level </label>
                                <div class="col-lg-6">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="taxLevel" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-4 offset-lg-2 col-form-label" for="deductionDate">Deduction Date </label>
                                <div class="col-lg-6">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="deductionDate" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-lg-4 offset-lg-2 col-form-label" for="memDocNo">Memorial Doc. No </label>
                                <div class="col-lg-6">
                                    <input class="form-control form-control-sm form-control-solid-bg" type="text" id="memDocNo" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="row mb-3">
                                <div class="d-flex w-lg-85">
                                    <label class="col-form-label me-5">8.</label>
                            ...
                            <div class="row mb-3">
                                <div class="d-flex w-lg-85">
                                    <label class="col-form-label me-5">9.</label>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                            <div class="row mb-3">
                                <div class="d-flex w-lg-85">
                                    <label class="col-form-label ms-8 w-100">Download ALL (ZIP)</label>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-approval-recon/js/dn-display.js?v=1') }}"></script>
@endsection
