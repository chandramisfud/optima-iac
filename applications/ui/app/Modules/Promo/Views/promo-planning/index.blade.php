...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-planning/css/promo-planning-methods.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
                ...
                <div class="card-body">
                    <div class="row mb-2">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-12 col-sm-12 mb-lg-1 mb-2">
                                    ...
                                    <span class="svg-icon svg-icon-3 svg-icon-gray-500 position-absolute translate-middle ms-6" style="padding-top: 32px">
                                        ...
                                        <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_promo_planning_search" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-5 col-md-12 col-sm-12 mb-lg-1 mb-2">
                                    <div class="row">
                                        <label class="col-lg-4 text-lg-end pt-1062-2 pe-lg-0 pt-lg-0">Activity Start</label>
                                        <div class="col-lg-8">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 mb-lg-1 mb-2">
                            <div class="row mb-lg-1">
                                <div class="text-end">
                                    <button type="button" class="btn btn-sm btn-outline-optima w-lg-auto w-100 mb-lg-0 mb-2" id="dt_promo_planning_view">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-optima w-lg-125px w-100 mb-lg-0 mb-2" id="dt_promo_planning_upload" title="Upload File Excel">
                                        <span class="indicator-label">
                            ...
                            <div class="row">
                                <div class="text-end">
                                    <button type="button" class="btn btn-sm btn-outline-optima w-lg-125px w-100 mb-lg-0 mb-2" id="dt_promo_planning_download_template" title="Download Template Excel">
                                        <span class="indicator-label">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_promo_planning" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
...
@section('page-script')
    ...
    <script
        src="{{ asset('assets/pages/promo/promo-planning/js/promo-planning-methods.js?v=5') }}"></script>
@endsection
