                ...
                <div class="card-body">
                                ...
                                <div class="col-lg-3 col-md-12 col-sm-12 mb-lg-1 mb-2">
                                    ...
                                    <span
                                        ...
                                        <input type="text" class="form-control form-control-sm ps-10" name="search"
                                               value="" placeholder="Search" id="dt_promo_to_be_created_search"
                                               autocomplete="off">
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_promo_to_be_created"
...
@section('page-script')
    ...
    <script
        src="{{ asset('assets/pages/promo/promo-planning/js/promo-to-be-created-methods.js?v=2') }}"></script>
@endsection
