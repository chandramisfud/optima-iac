                    ...
                    <div class="row">
                        ...
                        <div class="row" id="manualMechanism">
                            <div class="col-lg-6 col-md-6 col-12">
                                <input type="text" class="form-control form-control-sm mb-2" name="mechanisme1" id="mechanisme1">
                                <span class="form-text text-muted"></span>
                                <input type="text" class="form-control form-control-sm mb-2" name="mechanisme2" id="mechanisme2">
                                <span class="form-text text-muted"></span>
                            </div>

                            <div class="col-lg-6 col-md-6 col-12">
                                <input type="text" class="form-control form-control-sm mb-2" name="mechanisme3" id="mechanisme3">
                                <span class="form-text text-muted"></span>
                                <input type="text" class="form-control form-control-sm mb-2" name="mechanisme4" id="mechanisme4">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12">
                        <textarea rows="5" maxlength="255" class="form-control form-control-sm" name="mechanism_notes" id="mechanism_notes" value=""></textarea>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
            </div>
