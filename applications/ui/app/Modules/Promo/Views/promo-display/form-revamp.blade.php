...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-display/css/promo-display-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-display/js/promo-display-form-revamp.js?v=5') }}"></script>
@endsection
