...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-display/css/dc-promo-display-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-display/js/promo-display-dc-form-revamp.js?v=2') }}"></script>
@endsection
