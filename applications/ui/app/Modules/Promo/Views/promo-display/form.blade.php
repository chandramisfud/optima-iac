...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-display/css/promo-display-form.css') }}" rel="stylesheet" type="text/css"/>
@endsection
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="row">
                                    <label class="offset-lg-2 col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="distributor">Distributor</label>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="row fv-row">
                                    ...
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                        <div class="input-group input-group-sm">
                                            <input type="text" class="form-control form-control-sm form-control-sm form-control-solid-bg text-end" name="baselineSales" id="baselineSales" autocomplete="off" value="0" inputmode="decimal" readonly/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row fv-row">
                                ...
                                <div class="row fv-row">
                                    <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="investmentBfrClose">Investment Before Close</label>
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                ...
                                <div class="row fv-row">
                                    <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="investmentClosedBalance">Investment Closed Balance</label>
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-12 col-12">
                                        <div class="row mb-3">
                                            <div class="d-flex align-items-center">
                                                <label class="col-form-label mt-1 me-5" for="review_file_label_1">1.</label>
                                                <input type="text" class="form-control form-control-sm review_file_label me-3" id="review_file_label_1" readonly/>
                                                ...
                                                <button class="btn btn-sm btn-optima flex-shrink-0 ms-2 btn_view " id="btn_view1" name="btn_view1" title="Show" value="1" disabled>
                                        ...
                                        <div class="row mb-3">
                                            <div class="d-flex align-items-center">
                                                <label class="col-form-label mt-1 me-5" for="review_file_label_2">2.</label>
                                                <input type="text" class="form-control form-control-sm review_file_label me-3" id="review_file_label_2" readonly/>
                                                ...
                                                <button class="btn btn-sm btn-optima flex-shrink-0 ms-2 btn_view " id="btn_view2" name="btn_view2" title="Show" value="2" disabled>
                                                    <span class="fa fa-eye text-white"> </span>
                                                </button>
                                        ...
                                        <div class="row mb-3">
                                            <div class="d-flex align-items-center">
                                                <label class="col-form-label mt-1 me-5" for="review_file_label_3">3.</label>
                                                <input type="text" class="form-control form-control-sm review_file_label me-3" id="review_file_label_3" readonly/>
                                                ...
                                                <button class="btn btn-sm btn-optima flex-shrink-0 ms-2 btn_view " id="btn_view3" name="btn_view3" title="Show" value="3" disabled>
                                                    <span class="fa fa-eye text-white"> </span>
                                                </button>
                                        ...
                                        <div class="row mb-3">
                                            <div class="d-flex align-items-center">
                                                <label class="col-form-label mt-1 me-5" for="review_file_label_4">4.</label>
                                                <input type="text" class="form-control form-control-sm review_file_label me-3" id="review_file_label_4" readonly/>
                                                ...
                                                <button class="btn btn-sm btn-optima flex-shrink-0 ms-2 btn_view " id="btn_view4" name="btn_view4" title="Show" value="4" disabled>
                                                    <span class="fa fa-eye text-white"> </span>
                                                </button>
                                    ...
                                    <div class="offset-lg-1 col-lg-5 col-md-12 col-12">
                                        <div class="row mb-3">
                                            <div class="d-flex align-items-center">
                                                <label class="col-form-label mt-1 me-5" for="review_file_label_5">5.</label>
                                                <input type="text" class="form-control form-control-sm review_file_label me-3" id="review_file_label_5" readonly/>
                                                ...
                                                <button class="btn btn-sm btn-optima flex-shrink-0 ms-2 btn_view " id="btn_view5" name="btn_view5" title="Show" value="5" disabled>
                                                    <span class="fa fa-eye text-white"> </span>
                                                </button>
                                        ...
                                        <div class="row mb-3">
                                            <div class="d-flex align-items-center">
                                                <label class="col-form-label mt-1 me-5" for="review_file_label_6">6.</label>
                                                <input type="text" class="form-control form-control-sm review_file_label me-3" id="review_file_label_6" readonly/>
                                                ...
                                                <button class="btn btn-sm btn-optima flex-shrink-0 ms-2 btn_view " id="btn_view6" name="btn_view6" title="Show" value="6" disabled>
                                                    <span class="fa fa-eye text-white"> </span>
                                                </button>
                                        ...
                                        <div class="row mb-3">
                                            <div class="d-flex align-items-center">
                                                <label class="col-form-label mt-1 me-5" for="review_file_label_7">7.</label>
                                                <input type="text" class="form-control form-control-sm review_file_label me-3" id="review_file_label_7" readonly/>
                                                ...
                                                <button class="btn btn-sm btn-optima flex-shrink-0 ms-2 btn_view " id="btn_view7" name="btn_view7" title="Show" value="7" disabled>
                                                    <span class="fa fa-eye text-white"> </span>
                                                </button>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-display/js/promo-display-form.js?v=5') }}"></script>
@endsection
