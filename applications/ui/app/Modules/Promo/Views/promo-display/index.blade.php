...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-display/css/promo-display-methods.css') }}" rel="stylesheet"
          type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-display/js/promo-display-methods.js?v=3') }}"></script>
@endsection
