<html>
    ...
    <body>
            ...
            <table style="border:solid 1px #000;border-collapse: collapse; width: 1920px"">
                <thead style="background-color: #366092; color: white">
                    <tr style="background-color: #366092; color: white">
                        ...
                        <th colspan="4" style="text-align: center; border:solid 1px #000;">{{ $strMonth1 }}</th>
                        <th colspan="4" style="text-align: center; border:solid 1px #000;">{{ $strMonth2 }}</th>
                ...
                @foreach(@$data as $data)
                    ...
                    <tr>
                        @if(str_contains($data->channel, 'Total'))
                            <td style="background-color: #DCE6F1; text-align: left;border:solid 1px #000;padding-left:5px" class="cell_label"></td>
                        @else
                        ...
                        @if(str_contains($data->channelhead, 'Total'))
                            ...
                            <td style="background-color: #366092; color: white; text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap"><b>{{ number_format($data->w21) }}</b></td>
                            <td style="background-color: #366092; color: white; text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap"><b>{{ number_format($data->inv21) }}</b></td>
                            <td style="background-color: #366092; color: white; text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap"><b>{{ number_format($data->w22) }}</b></td>
                            <td style="background-color: #366092; color: white; text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap"><b>{{ number_format($data->inv22) }}</b></td>
                        ...
                        @else
                            @if(str_contains($data->channel, 'Total'))
                                ...
                                <td style="background-color: #DCE6F1; text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap"><b>{{ number_format($data->w21) }}</b></td>
                                <td style="background-color: #DCE6F1; text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap"><b>{{ number_format($data->inv21) }}</b></td>
                                <td style="background-color: #DCE6F1; text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap"><b>{{ number_format($data->w22) }}</b></td>
                                <td style="background-color: #DCE6F1; text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap"><b>{{ number_format($data->inv22) }}</b></td>
                            ...
                            @else
                                ...
                                <td style=" text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap">{{ number_format($data->w21) }}</td>
                                <td style=" text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap">{{ number_format($data->inv21) }}</td>
                                <td style=" text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap">{{ number_format($data->w22) }}</td>
                                <td style=" text-align: right;border:solid 1px #000;padding-right:5px" class="cell_label text-nowrap">{{ number_format($data->inv22) }}</td>
        ...
        <table style="width: 100%; border-collapse: collapse;" cellspacing="0" cellpadding="0">
            <tr style="margin-top:10px;"><td width="500">File Attachment : </td></tr>
            <tr>
                <td class="email_intro">
