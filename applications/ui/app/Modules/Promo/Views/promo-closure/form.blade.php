...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-closure/css/promo-closure-form.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('button-toolbar-right')
    @if (@$method == "open")
        @include('toolbars.btn-back-open')
    @else
        @include('toolbars.btn-back-close')
    @endif
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-closure/js/promo-closure-form.js?v=3') }}"></script>
@endsection
