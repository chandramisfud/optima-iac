...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-closure/css/dc-promo-closure-form.css?v=' . microtime()) }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-closure/js/dc-promo-closure-form.js?v=9') }}"></script>
@endsection
