...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-closure/css/promo-closure-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-closure/js/promo-closure-form-revamp.js?v=1') }}"></script>
@endsection
