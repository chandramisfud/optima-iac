...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-closure/css/dc-promo-closure-form-recon.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-closure/js/promo-closure-dc-form-recon.js?v=1') }}"></script>
@endsection
