...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-closure/css/dc-promo-closure-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-closure/js/promo-closure-dc-form-revamp.js?v=2') }}"></script>
@endsection
