...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-closure/css/promo-closure-form-recon.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
{{--    <div class="row mb-2 d-none" id="tblMechanismListCreation">--}}
{{--        <div class="col-12">--}}
...
{{--                    <div class="row">--}}
{{--                        <div class="col-lg-12 col-12">--}}
{{--                            <table id="dt_mechanism_list_creation" class="table table-striped table-row-bordered table-responsive table-sm table-hover">--}}
{{--                                <thead class="fw-bold fs-6 text-gray-800 bg-optima text-white">--}}
{{--                                <tr>--}}
{{--                                    <th class="align-middle text-nowrap text-white text-center">No</th>--}}
{{--                                    <th class="align-middle text-nowrap text-white" colspan="5">Mechanism</th>--}}
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-closure/js/promo-closure-form-recon.js?v=1') }}"></script>
@endsection
