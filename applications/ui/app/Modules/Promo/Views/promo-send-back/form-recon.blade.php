...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-send-back/css/promo-send-back-form-recon.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('content')
    ...
    <div class="d-none" id="MechanismMatrixForm">
        <form id="form_mechanism_matrix" class="form" autocomplete="off">
                        ...
                        <div class="col-lg-4 col-12 ps-lg-1">
                            <div class="card shadow-sm h-100">
                                ...
                                <div class="card-body  overflow-auto h-286px">
                                    <div class="row mb-2">
                                        <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="actualDnClaim">Actual DN Claimed</label>
                                        <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                            <input type="text" class="form-control form-control-sm form-control-solid-bg text-end" name="actualDnClaim" id="actualDnClaim" autocomplete="off" value="0" readonly/>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="row mb-2 d-none" id="promoCalculatorBefore">
                        <div class="col-12">
                    ...
                    <div class="row mb-2 d-none" id="autoMechanismBeforeListSection">
                        <div class="col-12">
                            <div class="card shadow-sm card_auto_mechanism_before">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            <span class="fs-3 fw-bolder mt-1 me-auto">Mechanism - Creation</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12 col-12">
                                            <table id="dt_mechanism_input_before" class="table table-striped table-row-bordered table-responsive table-sm table-hover">
                                                <thead class="fw-bold fs-6 text-gray-800 bg-optima text-white">
                                                <tr>
                    ...
                    <div class="row mb-2" id="manualMechanismInputSection">
                        ...
                        <div class="col-lg-4 col-12 ps-lg-1">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body  overflow-auto h-286px">
                                    <div class="row mb-2">
                                        <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="actualDnClaimFreeText">Actual DN Claimed</label>
                                        <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                            <input type="text" class="form-control form-control-sm form-control-solid-bg text-end" name="actualDnClaim" id="actualDnClaimFreeText" autocomplete="off" value="0" readonly/>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-lg-4 col-12">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-send-back/js/promo-send-back-form-recon.js?v=53') }}"></script>
@endsection
