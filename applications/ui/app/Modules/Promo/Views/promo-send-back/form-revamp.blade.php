...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-send-back/css/promo-send-back-form-revamp.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-send-back/js/promo-send-back-form-revamp.js?v=47') }}"></script>
@endsection
