...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-approval/css/promo-approval-form-revamp.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-approval/js/promo-approval-form-revamp.js?v=8') }}"></script>
@endsection
