...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-approval/css/dc-promo-approval-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-approval/js/promo-approval-dc-form-revamp.js?v=2') }}"></script>
@endsection
