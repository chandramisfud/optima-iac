...
<div class="detail_content">
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 80%; border: 1px solid #DAD9D9">{{ @$data->promo->distributorLongDesc }}</td>
        </tr>
        <tr>
            <td style="width: 20%" class="cell_label">Channel</td>
            <td style="width: 80%; border: 1px solid #DAD9D9">{{ @$data->promo->channelDesc }}</td>
        </tr>
        <tr>
            <td style="width: 20%" class="cell_label">Account, Sub Account</td>
            <td style="width: 80%; border: 1px solid #DAD9D9">{{ @$data->promo->accountDesc . ',' . @$data->promo->subAccountDesc }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 80%; border: 1px solid #DAD9D9">{{ @$data->promo->groupBrandLongDesc }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 80%; border: 1px solid #DAD9D9">{{ @$data->promo->activityLongDesc }}</td>
        </tr>
        <tr>
            <td style="width: 20%" class="cell_label">Sub Activity</td>
            <td style="width: 80%; border: 1px solid #DAD9D9">{{ @$data->promo->subActivityLongDesc }}</td>
        </tr>
        <tr>
            <td style="width: 20%" class="cell_label">Activity Name</td>
            <td style="width: 80%; border: 1px solid #DAD9D9">{{ @$data->promo->activityDesc }}</td>
        </tr>
        <tr>
...
<div class="detail_value">
    <table>
        <tr>
            <td style="text-align:left;background-color: #8EB4E3;font-weight: bold;">SKU</td>
            <td style="background-color: #8EB4E3;font-weight: bold;">Mechanisme</td>
            <td style="text-align:right;background-color: #8EB4E3;font-weight: bold;width: 33%;">Cost (IDR) </td>
        </tr>
        @foreach(@$data->mechanism as $mechanism)
            <tr>
