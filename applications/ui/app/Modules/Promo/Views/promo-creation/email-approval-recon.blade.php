...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->prevNormalSales,2,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->prevIncrSales,2,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->prevTotSales,2,".",",") }}</td>
    </tr>
    <tr>
        <td style="text-align:left;padding-left: 10px;"></td>
        <td style="text-align:left;padding-left: 10px;"></td>
    ...
    <tr>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->prevInvestment,2,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->prevCostRatio,2,".",",")}} %</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->prevRoi,2,".",",") }} %</td>
    </tr>
</table>
<br>
<div class="header_section">
    ...
    <tr>
        <td style="text-align:left; padding-left:10px;border: 1px solid black;">
            @if($data->promoHeader->userApprover4<>"")
                <div class="detail_approval_on">{{ @$data->promoHeader->lastStatus4 }}<br/>{{ @$data->promoHeader->userApprover }}</div>
            @endif
        </td>
        <td style="text-align:left; padding-left:10px;border: 1px solid black;">
            @if($data->promoHeader->userApprover5<>"")
                <div class="detail_approval_on">{{ @$data->promoHeader->lastStatus5 }}<br/> {{ @$data->promoHeader->userApprover }}</div>
            @endif
        </td>
