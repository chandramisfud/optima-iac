...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-creation/css/promo-creation-form-cancel-request-recon.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-creation/js/promo-creation-form-cancel-request-recon.js') }}"></script>
@endsection
