...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-creation/css/dc-promo-creation-form-cancel-request.css') }}" rel="stylesheet" type="text/css"/>
@endsection
        ...
        <div class="col-md-12 col-12">
            <div class="card shadow-sm mb-3">
                <div class="card-body">
                    <form id="form_promo_cancel_request" class="form" autocomplete="off">
                        ...
                        <div class="row fv-row">
                            <div class="col-lg-6 mb-2">
                                <select class="form-select form-select-sm" data-control="select2" name="cancelReason" id="cancelReason" data-placeholder="Cancellation Reason" autocomplete="off" data-allow-clear="true">                                    <option></option>
                                </select>
                            </div>
                            <div class="col-lg-6 mb-2">
                    ...
                    <div class="separator border-2 my-3 border-secondary"></div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-creation/js/dc-promo-creation-form-cancel-request.js?v=5') }}"></script>
