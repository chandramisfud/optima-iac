...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-creation/css/dc-promo-creation-form.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
                                ...
                                <div class="row fv-row">
                                    ...
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                                        <div class="input-group input-group-sm">
                                            <input type="text" class="form-control form-control-sm cursor-pointer" name="startPromo" id="startPromo" autocomplete="off" tabindex="8">
                                            <span class="input-group-text">to</span>
                                            <input type="text" class="form-control form-control-sm cursor-pointer" name="endPromo" id="endPromo" autocomplete="off" tabindex="9">
                                        </div>
                                    </div>
                                </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-creation/js/dc-promo-creation-form.js?v=25') }}"></script>
    <script src="{{ asset('assets/pages/promo/promo-creation/js/dc-source-budget-list.js?v=2') }}"></script>
@endsection
