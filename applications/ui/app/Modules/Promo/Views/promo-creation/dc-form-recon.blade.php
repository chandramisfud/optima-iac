...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-creation/css/dc-promo-creation-form-recon.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-creation/js/dc-promo-creation-form-recon.js?v=17') }}"></script>
@endsection
