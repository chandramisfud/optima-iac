...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-creation/css/dc-promo-creation-promo-cancel-request-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-creation/js/dc-promo-creation-form-cancel-request-revamp.js?v=2') }}"></script>
@endsection
