...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-creation/css/dc-promo-creation-form-revamp.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-creation/js/dc-promo-creation-form-revamp.js?v=25') }}"></script>
@endsection
