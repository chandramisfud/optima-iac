...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-creation/css/promo-creation-form-cancel-request.css') }}" rel="stylesheet" type="text/css"/>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="row fv-row">
                                <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="activityDesc">Activity</label>
                                <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                            ...
                            <div class="row fv-row">
                                <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="activityName">Activity Name</label>
                                <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-12 col-12">
                                    <div class="row mb-2">
                                        <div class="d-flex align-items-center">
                                            <label class="col-form-label me-5" for="attachment1">1.</label>
                                            <input type="text" class="form-control form-control-sm w-lg-75" id="attachment1" data-row="1" readonly>
                                    ...
                                    <div class="row mb-2">
                                        <div class="d-flex align-items-center">
                                            <label class="col-form-label me-5" for="attachment2">2.</label>
                                            <input type="text" class="form-control form-control-sm w-lg-75" id="attachment2" data-row="2" readonly>
                                    ...
                                    <div class="row mb-2">
                                        <div class="d-flex align-items-center">
                                            <label class="col-form-label me-5" for="attachment3">3.</label>
                                            <input type="text" class="form-control form-control-sm w-lg-75" id="attachment3" data-row="3" readonly>
                                    ...
                                    <div class="row mb-2">
                                        <div class="d-flex align-items-center">
                                            <label class="col-form-label me-5" for="attachment4">4.</label>
                                            <input type="text" class="form-control form-control-sm w-lg-75" id="attachment4" data-row="4" readonly>
                                ...
                                <div class="offset-lg-1 col-lg-5 col-md-12 col-12">
                                    <div class="row mb-2">
                                        <div class="d-flex align-items-center">
                                            <label class="col-form-label me-5" for="attachment5">5.</label>
                                            <input type="text" class="form-control form-control-sm w-lg-75" id="attachment5" data-row="5" readonly>
                                    ...
                                    <div class="row mb-2">
                                        <div class="d-flex align-items-center">
                                            <label class="col-form-label me-5" for="attachment6">6.</label>
                                            <input type="text" class="form-control form-control-sm w-lg-75" id="attachment6" data-row="6" readonly>
                                    ...
                                    <div class="row mb-2">
                                        <div class="d-flex align-items-center">
                                            <label class="col-form-label me-5" for="attachment7">7.</label>
                                            <input type="text" class="form-control form-control-sm w-lg-75" id="attachment5" data-row="7" readonly>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-creation/js/promo-creation-form-cancel-request.js?v=4') }}"></script>
@endsection
