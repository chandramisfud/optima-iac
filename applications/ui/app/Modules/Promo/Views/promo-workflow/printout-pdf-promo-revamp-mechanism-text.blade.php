    ...
    <di id="cycle1">
        ...
        <div class="detail_value">
            <table>
                ...
                <tr>
                    <td>All Value</td>
                    <td style="text-align:right; width: 33%"> {{ @number_format($data->promoCreation->mechanism[0]->cost,0,".",",") }} </td>
                </tr>
            </table>
        </div>
    ...
    @if (@$data->promoRecon != null)
        ...
        <div class="detail_value">
            <table>
                ...
                <tr>
                    <td>All Value</td>
                    <td style="text-align:right; width: 33%"> {{ @number_format($data->promoRecon->mechanism[0]->cost,0,".",",") }} </td>
                </tr>
            </table>
        </div>
