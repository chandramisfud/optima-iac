...
@for ($i=0;$i<count($arrData);$i++)
    ...
    <div class="detail_value">
        <table>
            ...
            <tr>
                <td>All Value</td>
                <td style="text-align:right"> {{ @number_format(json_decode($arrData[$i])->promoHeader->prevNormalSales,0,".",",") }} </td>
                <td style="text-align:right"> {{ @number_format(json_decode($arrData[$i])->promoHeader->prevIncrSales,0,".",",") }} </td>
                <td style="text-align:right"> {{ @number_format(json_decode($arrData[$i])->promoHeader->prevInvestment,0,".",",") }} </td>
            </tr>
            <tr>
                <td><b>Total</b></td>
                <td style="text-align:right"><b>{{ @number_format(json_decode($arrData[$i])->promoHeader->prevNormalSales,0,".",",") }}</b></td>
                <td style="text-align:right"><b>{{ @number_format(json_decode($arrData[$i])->promoHeader->prevIncrSales,0,".",",") }}</b></td>
                <td style="text-align:right"><b>{{ @number_format(json_decode($arrData[$i])->promoHeader->prevInvestment,0,".",",") }} </b></td>
            </tr>
            {{--<tr>
        ...
        <table>
            ...
            <tr class="detail_analysis_content">
                ...
                <td class="col_mid" style="text-align:right">
                    {{ @number_format((double)json_decode($arrData[$i])->promoHeader->prevNormalSales + json_decode($arrData[$i])->promoHeader->prevIncrSales,0,".",",") }}
                </td>
            ...
            <tr class="detail_analysis_content">
                ...
                <td class="col_mid" style="text-align:right"> {{ @number_format((double)json_decode($arrData[$i])->promoHeader->prevInvestment,0,".",",") }}</td>
            </tr>
            <tr class="detail_analysis_content">
                <td class="col_left">ROI</td>
                <td class="col_mid" style="text-align:right">  {{ @number_format((double)json_decode($arrData[$i])->promoHeader->prevRoi,1,".",",") }} %</td>
            </tr>
            <tr class="detail_analysis_content">
                <td class="col_left">Cost Ratio</td>
                <td class="col_mid" style="text-align:right">{{ @number_format((double)json_decode($arrData[$i])->promoHeader->prevCostRatio,1,".",",") }} %</td>
            </tr>
        </table>
    </div>
    <div >
    ...
    <div class="detail_value">
        <table>
            ...
            <tr>
                <td>All Value</td>
                <td style="text-align:right"> {{ @number_format(json_decode($arrData[$i])->promoHeader->normalSales,0,".",",") }} </td>
                <td style="text-align:right"> {{ @number_format(json_decode($arrData[$i])->promoHeader->incrSales,0,".",",") }} </td>
                <td style="text-align:right"> {{ @number_format(json_decode($arrData[$i])->promoHeader->investment,0,".",",") }} </td>
            </tr>
            <tr>
                <td><b>Total</b></td>
                <td style="text-align:right"><b>{{ @number_format(json_decode($arrData[$i])->promoHeader->normalSales,0,".",",") }}</b></td>
                <td style="text-align:right"><b>{{ @number_format(json_decode($arrData[$i])->promoHeader->incrSales,0,".",",") }}</b></td>
                <td style="text-align:right"><b>{{ @number_format(json_decode($arrData[$i])->promoHeader->investment,0,".",",") }} </b></td>
            </tr>
            {{--<tr>
                <td><b>Running Rate Cost</b></td>
                <td style="text-align:right"><b></b></td>
    ...
    <div class="detail_analysis">
        <table>
            ...
            <tr class="detail_analysis_content">
                <td class="col_left">Total sales (a+b)</td>
                <td class="col_mid" style="text-align:right">
                    {{ @number_format((double)json_decode($arrData[$i])->promoHeader->normalSales + json_decode($arrData[$i])->promoHeader->incrSales,0,".",",") }}
                </td>
                {{-- <td class="col_right" style="vertical-align: top;" rowspan="4">
                     @json_decode($arrData[$i])->promoHeader->categoryDesc
                </td> --}}
            ...
            <tr class="detail_analysis_content">
                <td class="col_left">Investment (c)</td>
                <td class="col_mid" style="text-align:right"> {{ @number_format((double)json_decode($arrData[$i])->promoHeader->investment,0,".",",") }}</td>
            </tr>
            <tr class="detail_analysis_content">
                <td class="col_left">ROI</td>
                <td class="col_mid" style="text-align:right">  {{ @number_format((double)json_decode($arrData[$i])->promoHeader->roi,1,".",",") }} %</td>
            </tr>
            <tr class="detail_analysis_content">
                <td class="col_left">Cost Ratio</td>
                <td class="col_mid" style="text-align:right">{{ @number_format((double)json_decode($arrData[$i])->promoHeader->costRatio,1,".",",") }} %</td>
            </tr>
        </table>
    </div>
    <div >
