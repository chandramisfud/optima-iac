...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-approval/css/promo-approval-form-recon.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-cancel-request/js/promo-cancel-request-form-recon.js?v=1') }}"></script>
@endsection
