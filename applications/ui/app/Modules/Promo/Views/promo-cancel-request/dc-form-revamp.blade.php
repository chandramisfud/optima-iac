...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-cancel-request/css/dc-promo-cancel-request-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-cancel-request/js/promo-cancel-request-dc-form-revamp.js?v=1') }}"></script>
@endsection
