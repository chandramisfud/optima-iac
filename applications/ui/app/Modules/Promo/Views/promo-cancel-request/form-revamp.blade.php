...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-approval/css/promo-approval-form-revamp.css') }}" rel="stylesheet" type="text/css"/>
@endsection
        ...
        <div class="col-md-12 col-12">
            <div class="card shadow-sm mb-2">
                <div class="card-body card_form">
                    ...
                    <form id="form_promo_cancel" class="form" autocomplete="off">
                        @csrf
                        <div class="row">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-cancel-request/js/promo-cancel-request-form-revamp.js?v=1') }}"></script>
@endsection
