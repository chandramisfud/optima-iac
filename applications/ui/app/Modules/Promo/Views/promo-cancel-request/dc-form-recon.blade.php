...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-cancel-request/css/dc-promo-cancel-request-form-recon.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-cancel-request/js/promo-cancel-request-dc-form-recon.js?v=1') }}"></script>
@endsection
