...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-recon-send-back/css/dc-promo-recon-send-back-form.css?v=1') }}" rel="stylesheet" type="text/css"/>
@endsection
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="row fv-row">
                                    ...
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                        <input type="text" class="form-control form-control-sm text-end" data-kt-dialer-control="input" name="investmentRecon" id="investmentRecon" autocomplete="off" value="0" tabindex="11"/>
                                    </div>
                                </div>
                                ...
                                <div class="row fv-row">
                                    ...
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                                        <input class="form-control form-control-sm" type="text" name="initiatorNotes" id="initiatorNotes" tabindex="12" autocomplete="off"/>
                                    </div>
                                </div>
                            </div>
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-recon-send-back/js/dc-promo-recon-send-back-form.js?v=20') }}"></script>
    <script src="{{ asset('assets/pages/promo/promo-recon-send-back/js/dc-source-budget-list.js?v=1') }}"></script>
@endsection
