...
@section('page-style')
    <link href="{{ asset('assets/pages/promo/promo-recon-send-back/css/promo-recon-send-back-form.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="row fv-row">
                                    <label class="offset-lg-2 col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="subCategoryId">Sub Category</label>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="row fv-row">
                                            <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="baselineSalesRecon">Baseline Sales</label>
                                            <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                                <div class="input-group input-group-sm">
                                        ...
                                        <div class="row">
                                            <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="totalSalesRecon">Total Sales</label>
                                            <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <div class="row">
                                            <label class="col-lg-4 col-md-12 col-sm-12 col-12 col-form-label" for="estimatedInvestment">Estimated Investment</label>
                                            <div class="col-lg-8 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="row fv-row">
                                            <label class="offset-lg-2 col-lg-4 col-md-12 col-sm-12 col-12 col-form-label required" for="investmentRecon">Final Investment Amount</label>
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-12 ">
    ...
    @include('Promo::promo-recon-send-back.source-budget-list')
    @include('Promo::promo-recon-send-back.form-attribute')
@endsection
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/promo/promo-recon-send-back/js/promo-recon-send-back-form.js?v=27') }}"></script>
    <script src="{{ asset('assets/pages/promo/promo-recon-send-back/js/source-budget-list.js?v=1') }}"></script>
    <script src="{{ asset('assets/pages/promo/promo-recon-send-back/js/promo-recon-send-back-form-attribute.js?v=15') }}"></script>
@endsection
