...
<div class="header_section">
    <table>
        <tr>
            <td colspan="3" style="color:#196DB5;text-decoration: underline;"><b>Current</b> </td>
        </tr>
    </table>
</div>
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->normalSales,0,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->incrSales,0,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">
            <?php
            $totsales = $data->promoHeader->normalSales + $data->promoHeader->incrSales;
...
<div class="header_section">
    <table>
        <tr>
            <td colspan="3" style="color:#196DB5;text-decoration: underline;"><b>Previous</b> </td>
        </tr>
    </table>
</div>
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->lastNormalSales,2,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->lastIncrSales,2,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->lastTotSales,2,".",",") }}</td>
    </tr>
    <tr>
        <td style="text-align:left;padding-left: 10px;"></td>
        <td style="text-align:left;padding-left: 10px;"></td>
    ...
    <tr>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->lastInvestment,2,".",",") }}</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->lastCostRatio,2,".",",")}} %</td>
        <td style="text-align:right; padding-right:10px;border: 1px solid black;">{{ @number_format($data->promoHeader->lastRoi,2,".",",") }} %</td>
    </tr>
</table>
<br>
<div class="header_section">
    ...
    <tr>
        <td style="text-align:left; padding-left:10px;border: 1px solid black;">
            @if($data->promoHeader->userApprover1<>"")
                <div class="detail_approval_on">{{ @$data->promoHeader->lastStatus1 }}<br/>{{ @$data->promoHeader->userApprover1Name }}</div>
            @endif
        </td>
        <td style="text-align:left; padding-left:10px;border: 1px solid black;">
            @if($data->promoHeader->userApprover2<>"")
                <div class="detail_approval_on">{{ @$data->promoHeader->lastStatus2 }}<br/>{{ @$data->promoHeader->userApprover2Name }}</div>
            @endif
        </td>
        <td style="text-align:left; padding-left:10px;border: 1px solid black;">
            @if($data->promoHeader->userApprover3<>"")
                <div class="detail_approval_on">{{ @$data->promoHeader->lastStatus3 }}<br/> {{ @$data->promoHeader->userApprover3Name }}</div>
            @endif
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="text-align:left; padding-left:10px;border: 1px solid black;">
            @if($data->promoHeader->userApprover4<>"")
                <div class="detail_approval_on">{{ @$data->promoHeader->lastStatus4 }}<br/>{{ @$data->promoHeader->userApprover4Name }}</div>
            @endif
        </td>
        <td style="text-align:left; padding-left:10px;border: 1px solid black;">
            @if($data->promoHeader->userApprover5<>"")
                <div class="detail_approval_on">{{ @$data->promoHeader->lastStatus5 }}<br/> {{ @$data->promoHeader->userApprover5Name }}</div>
            @endif
        </td>
...
<table cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td style="border-radius: 2px;" bgcolor="#5867dd">
            <a href="{{ config('app.url') . "/promo/approval-recon/email/approve?p=" . @$paramEncrypted }}" target="_blank" style="padding: 8px 12px; border: 1px solid #5867dd;border-radius: 2px;font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;text-decoration: none;font-weight:bold;display: inline-block;">
                Approve
            </a>
        ...
        <td width="30"></td>
        <td style="border-radius: 2px;" bgcolor="#5867dd">
            <a href="{{ config('app.url') . "/promo/approval-recon/email/send-back?p=" . @$paramEncrypted }}" target="_blank" style="padding: 8px 12px; border: 1px solid #5867dd;border-radius: 2px;font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;text-decoration: none;font-weight:bold;display: inline-block;">
                Send Back
            </a>
        </td>
    </tr>
