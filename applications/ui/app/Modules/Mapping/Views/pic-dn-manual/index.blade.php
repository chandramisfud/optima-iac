                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2-5 col-md-12 col-sm-12 mb-lg-0 mb-2">
                            <div class="inner-addon left-addon right-addon">
                                ...
                                <input type="text" class="form-control form-control-sm ps-10" name="search" value="" placeholder="Search" id="dt_pic_dn_manual_search" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <table id="dt_pic_dn_manual" class="table table-striped table-row-bordered table-responsive table-sm table-hover"></table>
                        </div>
                    </div>
                </div>
            </div>
...
@section('page-script')
    <script src="{{ asset('assets/pages/mapping/pic-dn-manual/js/pic-dn-manual-methods.js?v=4') }}"></script>
@endsection
