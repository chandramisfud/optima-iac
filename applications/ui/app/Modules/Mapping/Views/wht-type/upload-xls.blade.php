        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header px-5">
                    <span class="card-title fs-3">WHT Type Upload <small class="text-muted fs-6 my-0 fw-bold ms-5">List</small></span>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/mapping/wht-type/js/wht-type-upload-xls.js?v=1') }}"></script>
@endsection
