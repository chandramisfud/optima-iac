    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card shadow-sm card_form">
                <div class="card-body">
                    <form id="form_mapping_sub_account_blitz" class="form" autocomplete="off">
                        @csrf
                        ...
                        <div class="row fv-row">
                            <label class="col-lg-3 col-form-label required">Blitz Sub Account Code</label>
                            <div class="col-lg-5">
                                <input class="form-control form-control-sm" type="text" name="sapCode" id="sapCode" placeholder="Enter Blitz Sub Account Code" autocomplete="off" tabindex="5" />
                            </div>
                        </div>
                    </form>
                </div>
...
@section('page-script')
    <script src="{{ asset('assets/pages/mapping/sub-account-blitz/js/sub-account-blitz-form.js?v=1') }}"></script>
@endsection
