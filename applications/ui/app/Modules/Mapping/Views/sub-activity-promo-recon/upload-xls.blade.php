        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header px-5">
                    <span class="card-title fs-3">Mapping Sub Activity for Allow Edit Promo Recon <small class="text-muted fs-6 my-0 fw-bold ms-5">Error</small></span>
                </div>
                <div class="card-body">
                    <div class="row">
...
@section('page-script')
    ...
    <script src="{{ asset('assets/pages/mapping/sub-activity-promo-recon/js/sub-activity-promo-recon-upload-xls.js?v=' . microtime()) }}"></script>
@endsection
